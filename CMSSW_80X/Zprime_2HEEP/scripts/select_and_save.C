...
TString Regress=74;//80 or 74 regression
...
//TString input_dir="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/ee_channel/reskim_script/reskim_out/for_Zprime/";
TString input_dir="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/ee_channel/reskim_script/reskim_out/for_Zprime/genMatchCorrect/";
TString output_dir="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Zprime_2HEEP/ntuples/sys_saved_hist/0805_genMatch/";
bool do_fewz=true;
...
fill_hist(input_dir+   "ZToEE_M_50_120.root",output_dir+str_uncert+   "hist_ZToEE_50_120"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+  "ZToEE_M_120_200.root",output_dir+str_uncert+  "hist_ZToEE_120_200"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+  "ZToEE_M_200_400.root",output_dir+str_uncert+  "hist_ZToEE_200_400"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+  "ZToEE_M_400_800.root",output_dir+str_uncert+  "hist_ZToEE_400_800"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+ "ZToEE_M_800_1400.root",output_dir+str_uncert+ "hist_ZToEE_800_1400"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_1400_2300.root",output_dir+str_uncert+"hist_ZToEE_1400_2300"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_2300_3500.root",output_dir+str_uncert+"hist_ZToEE_2300_3500"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_3500_4500.root",output_dir+str_uncert+"hist_ZToEE_3500_4500"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_4500_6000.root",output_dir+str_uncert+"hist_ZToEE_4500_6000"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir+ "ZToEE_M_6000_Inf.root",output_dir+str_uncert+ "hist_ZToEE_6000_Inf"+str_fewz+".root",false,true,do_fewz,false,false,uncertainty);

fill_hist(input_dir+   "ZToEE_M_50_120.root",output_dir+str_uncert+   "hist_ZToEE_50_120"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+  "ZToEE_M_120_200.root",output_dir+str_uncert+  "hist_ZToEE_120_200"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+  "ZToEE_M_200_400.root",output_dir+str_uncert+  "hist_ZToEE_200_400"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+  "ZToEE_M_400_800.root",output_dir+str_uncert+  "hist_ZToEE_400_800"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+ "ZToEE_M_800_1400.root",output_dir+str_uncert+ "hist_ZToEE_800_1400"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_1400_2300.root",output_dir+str_uncert+"hist_ZToEE_1400_2300"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_2300_3500.root",output_dir+str_uncert+"hist_ZToEE_2300_3500"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_3500_4500.root",output_dir+str_uncert+"hist_ZToEE_3500_4500"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+"ZToEE_M_4500_6000.root",output_dir+str_uncert+"hist_ZToEE_4500_6000"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir+ "ZToEE_M_6000_Inf.root",output_dir+str_uncert+ "hist_ZToEE_6000_Inf"+str_fewz+"_1F.root",false,true,do_fewz,true,false,uncertainty);

if(uncertainty!="pdf_scale_up" && uncertainty!="pdf_scale_down"){
fill_hist(input_dir+"ZToTT_amc_M50.root"                         ,output_dir+str_uncert+"hist_ZToTT_amc.root"        ,false,false,false,false,false,uncertainty);
...
fill_hist(input_dir+"ST_tW_top_5f_NoFullyHadronicDecays.root"    ,output_dir+str_uncert+"hist_ST.root"               ,false,false,false,false,false,uncertainty);
fill_hist(input_dir+"ST_tW_antitop_5f_NoFullyHadronicDecays.root",output_dir+str_uncert+"hist_ST_anti.root"          ,false,false,false,false,false,uncertainty);
...
fill_hist(input_dir+"ZToTT_amc_M50.root"                         ,output_dir+str_uncert+"hist_ZToTT_amc_1F.root"        ,false,false,false,true,false,uncertainty);
...
fill_hist(input_dir+"ST_tW_top_5f_NoFullyHadronicDecays.root"    ,output_dir+str_uncert+"hist_ST_1F.root"               ,false,false,false,true,false,uncertainty);
fill_hist(input_dir+"ST_tW_antitop_5f_NoFullyHadronicDecays.root",output_dir+str_uncert+"hist_ST_anti_1F.root"          ,false,false,false,true,false,uncertainty);
...
//////////////////////////////////////
   ...
   t->SetBranchAddress("heeps_74_match"                       , &heeps_74_match       ) ;
   }
...
TH1D *h_mee_all_cum        =new TH1D("h_mee_all_cumlative",""     ,197,60,4000);
TH1D *h_mee_all_cum_BE     =new TH1D("h_mee_all_cumlative_BE",""  ,197,60,4000);
TH1D *h_mee_all_cum_BB     =new TH1D("h_mee_all_cumlative_BB",""  ,197,60,4000);
TH1D *h_mee_all_cum_EE     =new TH1D("h_mee_all_cumlative_EE",""  ,197,60,4000);
//////////////////
...
TH1D *h_pv_n               =new TH1D("h_pv_n","",40,0,40);
...
TH2D *h_Mee_diff           =new TH2D("h_Mee_diff"   ,"",200,0,4000,200,-1,1);//for mee diff between 74X and 80X (80-74)/74
TH2D *h_Mee_diff_BB        =new TH2D("h_Mee_diff_BB","",200,0,4000,200,-1,1);//for mee diff between 74X and 80X (80-74)/74
TH2D *h_Mee_diff_BE        =new TH2D("h_Mee_diff_BE","",200,0,4000,200,-1,1);//for mee diff between 74X and 80X (80-74)/74
TH2D *h_Mee_diff_EE        =new TH2D("h_Mee_diff_EE","",200,0,4000,200,-1,1);//for mee diff between 74X and 80X (80-74)/74
...
bool check_80X =false;//check the 80X
bool MET_detail=false;//check the MET
bool match_check=true;//check match
...
ofstream fout("Wx_data_0610_new.txt");
...
e1_pass_trigger=trigEle33::passTrig(heeps_et->at(j), heeps_sc_eta->at(j)) ;
    }
...
e2_pass_trigger=trigEle33::passTrig(heeps_et->at(k), heeps_sc_eta->at(k)) ;
    }
...
//if(ev_event==909081649) std::cout<<"fire:"<<trig_DEle33_MW<<",pass:"<<e1_pass_trigger<<",HEEP"<<heeps_isHEEP7->at(j)<<",sc eta"<<heeps_sc_eta->at(j)<<std::endl;
if(e1_pass_trigger==0 || heeps_isHEEP7->at(j)==0 || (fabs(heeps_sc_eta->at(j))>1.4442 && fabs(heeps_sc_eta->at(j))<1.566) || fabs(heeps_sc_eta->at(j))>2.5) continue;
for(unsigned int k=j+1;k<heeps_et->size();k++){
int e2_pass_trigger=0;
if(is_data){ if(ev_run>=trig_Calo_trID_run_low && ev_run<=trig_Calo_trID_run_up) e2_pass_trigger=trigger_match(heeps_sc_eta->at(k),heeps_sc_phi->at(k),trig_DEle33_unseed_eta,trig_DEle33_unseed_phi,trig_DEle33);
...
float mee=Zee.M();
//////////////for match check //////////////////
if(match_check){ if(heeps_74_match->at(e1_index)==0 || heeps_74_match->at(e2_index)==0) {
...
//////// for 80X check /////////////
float mee_80=0;
if(check_80X && is_data && Regress==74){// for Regress=80 seems have problem
int e1_index_80=-1;
int e2_index_80=-1;
e1_index_80 = matching(heeps_80X_eta, heeps_80X_phi, heeps_eta->at(e1_index), heeps_phi->at(e1_index));
e2_index_80 = matching(heeps_80X_eta, heeps_80X_phi, heeps_eta->at(e2_index), heeps_phi->at(e2_index));

if(e1_index_80 !=-1 && e2_index_80!=-1 && (e1_index_80 != e2_index_80)){
TLorentzVector e1_80(0,0,0,0);
TLorentzVector e2_80(0,0,0,0);
e1_80.SetPtEtaPhiM(heeps_80X_et->at(e1_index_80),heeps_80X_eta->at(e1_index_80),heeps_80X_phi->at(e1_index_80),m_el);
e2_80.SetPtEtaPhiM(heeps_80X_et->at(e2_index_80),heeps_80X_eta->at(e2_index_80),heeps_80X_phi->at(e2_index_80),m_el);
mee_80=(e1_80+e2_80).M();
}

}
float m_diff= mee!=0 ?(mee_80-mee)/mee : 0;

//if(mee>500) std::cout<<"event="<<ev_event<<",mee="<<mee<<",e1 Et="<<e1.Pt()<<",e1 eta="<<e1.Eta()<<",e1 phi="<<e1.Phi()<<",e1 charge="<<heeps_charge->at(e1_index)<<",e2 Et="<<e2.Pt()<<",e2 eta="<<e2.Eta()<<",e2 phi="<<e2.Phi()<<",e2 charge="<<heeps_charge->at(e2_index)<<std::endl;
///////////// calcCosThetaCSAnal ////////////
double CosThetaCS=0;
int same_sign=0;
...
///////////////////////// mass scale //////////////////////
/*
if     (uncert=="BB_mass_scale_up")  {if(fabs(e1_sc_eta)<1.4442 && fabs(e2_sc_eta)<1.4442 ){if(mee<120) mee=1.005*mee;
                                                                                            else        mee=1.02*mee;
                                                                                           }
                                     }
else if(uncert=="BB_mass_scale_down"){if(fabs(e1_sc_eta)<1.4442 && fabs(e2_sc_eta)<1.4442 ){ if(mee<120) mee=0.995*mee;
                                                                                             else        mee=0.98*mee;
                                                                                           }
                                     }
else if(uncert=="BE_mass_scale_up")  {if( (fabs(e1_sc_eta)<1.4442 && fabs(e2_sc_eta)>1.566 && fabs(e2_sc_eta)<2.5) || (fabs(e2_sc_eta)<1.4442 && fabs(e1_sc_eta)>1.566 && fabs(e1_sc_eta)<2.5) ){if(mee<120) mee=1.0025*mee;
                                                                                                                                                                                                 else        mee=1.01*mee;
                                                                                                                                                                                                } 
                                     }
else if(uncert=="BE_mass_scale_down"){if( (fabs(e1_sc_eta)<1.4442 && fabs(e2_sc_eta)>1.566 && fabs(e2_sc_eta)<2.5) || (fabs(e2_sc_eta)<1.4442 && fabs(e1_sc_eta)>1.566 && fabs(e1_sc_eta)<2.5) ){if(mee<120) mee=0.9975*mee;
                                                                                                                                                                                                 else        mee=0.99*mee;
                                                                                                                                                                                                } 
                                     }
*/
...
h_Mee_diff_EE->Fill(mee,m_diff,event_weight);
continue;
}
                                    ...
                                    if(mee<(h_mee_all_cum_BB->GetBinLowEdge(h_mee_all_cum_BB->GetNbinsX())+h_mee_all_cum_BB->GetBinWidth(h_mee_all_cum_BB->GetNbinsX()))) {h_mee_all_cum_BB->Fill(mee,event_weight);
                                               ...
                                               h_Mee_diff_BB->Fill(mee,m_diff,event_weight);
                                                                          ...
                                                                          h_Mee_diff_BE->Fill(mee,m_diff,event_weight);
...
h_Mee_diff->Fill(mee,m_diff,event_weight);
...
h_cos_EE        ->Delete(); 
h_Mee_diff      ->Delete(); 
h_Mee_diff_BB   ->Delete(); 
h_Mee_diff_BE   ->Delete(); 
h_Mee_diff_EE   ->Delete(); 
