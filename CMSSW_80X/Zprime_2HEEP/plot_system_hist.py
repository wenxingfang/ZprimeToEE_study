...
#    legend.AddEntry(g_tmp_uncertainty,'Uncert.(stat.#oplussyst.)','f')
...
##    g_mc_stat.Draw("2p")
    ...
    canvas.Print('%s/%s/%s.pdf'%(out_dir,date,out_name))    
#    ################ Fit background ####################
    if out_name in ["h_mee_usual","h_mee_BB_usual","h_mee_BE_usual","h_mee_all","h_mee_all_BB","h_mee_all_BE","h_mee_all_EE"] and True:
        f_bgk_out= ROOT.TFile("bgk.root","UPDATE");
        f_bgk_out.cd()
...
########### For sin ratio plots ################################
    if out_name in final_out_name and 'sin' in out_name and True : 
        ...
        canvas_ratio.SetRightMargin(0.07)
        canvas_ratio.SetFrameBorderMode(0)
        canvas_ratio.SetFrameBorderMode(0)
        canvas_ratio.SetTopMargin(0.085)
...
def Set_and_Draw(date, out_dir, hname, System_uncertainty, total_hist, ttbar_other_hist, ZToEE_hist, Jets_hist, ASF_dict):
    ...
    for hist in System_uncertainty["nominal"].sample_hist["data"]:
        ...
        #        stack_mc.Add(h_tmp)
        h_Jets.SetFillColor(ROOT.kYellow) ##official color
...
class file_object:
    def __init__(self, file_name, name, event, crosssection, color):
        ...
        self.color = color
        #self.tfilename = 'ntuples/sys_saved_hist/80X/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/all_m200/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/0606_80X_v2/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/0607/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/0607_Z_match/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/0607_sys/%s.root'%(self.file_name)#HEEP sf uncertainty 
        #self.tfilename = 'ntuples/sys_saved_hist/0714_sys_sf/%s.root'%(self.file_name)#HEEP sf uncertainty linearly increase
        #self.tfilename = 'ntuples/sys_saved_hist/0716_sys/%s.root'%(self.file_name)#HEEP sf uncertainty linearly increase, mass scale after fewz weight
        #self.tfilename = 'ntuples/sys_saved_hist/0716_sys_Mscale_m120/%s.root'%(self.file_name)#HEEP sf uncertainty linearly increase, mass scale after fewz weight, add small uncertainty for m<120
        #self.tfilename = 'ntuples/sys_saved_hist/0717_Zmatch/%s.root'%(self.file_name)#gen match for ZToEE sample
        #self.tfilename = 'ntuples/sys_saved_hist/no_PUreweight/%s.root'%(self.file_name)
        self.tfilename = 'ntuples/sys_saved_hist/0805_genMatch/%s.root'%(self.file_name)#HEEP sf uncertainty linearly increase, mass scale after fewz weight, add small uncertainty for m<120
        self.tfile = ROOT.TFile(self.tfilename,'READ')


class collcet_hist:
    def __init__(self, name, fewz_correct, TTbar_MLL, sys_uncert):
        self.name=name
...
#        self.DY_pdf_6000_Inf =DY_pdf_new(6000,7500)
        ...
        self.Xsection['WZ']             =  47.13   
        self.Xsection['WZ_3LNu']        =  4.42965   
        self.Xsection['WZ_2L2Q']        =  5.595   
        self.Xsection['ZZ']             =  16.523   
...
#        if self.sys_uncert == "pdf_50_120_scale_up":
#            self.Xsection['ZToEE_50_120']   =(1+self.DY_pdf_50_120)*self.Xsection['ZToEE_50_120']   
#        elif self.sys_uncert == "pdf_50_120_scale_down":
#            self.Xsection['ZToEE_50_120']   =(1-self.DY_pdf_50_120)*self.Xsection['ZToEE_50_120']   
#        elif self.sys_uncert == "pdf_120_200_scale_up":
#            self.Xsection['ZToEE_120_200']   =(1+self.DY_pdf_120_200)*self.Xsection['ZToEE_120_200']   
#        elif self.sys_uncert == "pdf_120_200_scale_down":
#            self.Xsection['ZToEE_120_200']   =(1-self.DY_pdf_120_200)*self.Xsection['ZToEE_120_200']   
#        elif self.sys_uncert == "pdf_200_400_scale_up":
#            self.Xsection['ZToEE_200_400']   =(1+self.DY_pdf_200_400)*self.Xsection['ZToEE_200_400']   
#        elif self.sys_uncert == "pdf_200_400_scale_down":
#            self.Xsection['ZToEE_200_400']   =(1-self.DY_pdf_200_400)*self.Xsection['ZToEE_200_400']   
#        elif self.sys_uncert == "pdf_400_800_scale_up":
#            self.Xsection['ZToEE_400_800']   =(1+self.DY_pdf_400_800)*self.Xsection['ZToEE_400_800']   
#        elif self.sys_uncert == "pdf_400_800_scale_down":
#            self.Xsection['ZToEE_400_800']   =(1-self.DY_pdf_400_800)*self.Xsection['ZToEE_400_800']   
#        elif self.sys_uncert == "pdf_800_1400_scale_up":
#            self.Xsection['ZToEE_800_1400']   =(1+self.DY_pdf_800_1400)*self.Xsection['ZToEE_800_1400']   
#        elif self.sys_uncert == "pdf_800_1400_scale_down":
#            self.Xsection['ZToEE_800_1400']   =(1-self.DY_pdf_800_1400)*self.Xsection['ZToEE_800_1400']   
#        elif self.sys_uncert == "pdf_1400_2300_scale_up":
#            self.Xsection['ZToEE_1400_2300']   =(1+self.DY_pdf_1400_2300)*self.Xsection['ZToEE_1400_2300']   
#        elif self.sys_uncert == "pdf_1400_2300_scale_down":
#            self.Xsection['ZToEE_1400_2300']   =(1-self.DY_pdf_1400_2300)*self.Xsection['ZToEE_1400_2300']   
#        elif self.sys_uncert == "pdf_2300_3500_scale_up":
#            self.Xsection['ZToEE_2300_3500']   =(1+self.DY_pdf_2300_3500)*self.Xsection['ZToEE_2300_3500']   
#        elif self.sys_uncert == "pdf_2300_3500_scale_down":
#            self.Xsection['ZToEE_2300_3500']   =(1-self.DY_pdf_2300_3500)*self.Xsection['ZToEE_2300_3500']   
#        elif self.sys_uncert == "pdf_3500_4500_scale_up":
#            self.Xsection['ZToEE_3500_4500']   =(1+self.DY_pdf_3500_4500)*self.Xsection['ZToEE_3500_4500']   
#        elif self.sys_uncert == "pdf_3500_4500_scale_down":
#            self.Xsection['ZToEE_3500_4500']   =(1-self.DY_pdf_3500_4500)*self.Xsection['ZToEE_3500_4500']   
#        elif self.sys_uncert == "pdf_4500_6000_scale_up":
#            self.Xsection['ZToEE_4500_6000']   =(1+self.DY_pdf_4500_6000)*self.Xsection['ZToEE_4500_6000']   
#        elif self.sys_uncert == "pdf_4500_6000_scale_down":
#            self.Xsection['ZToEE_4500_6000']   =(1-self.DY_pdf_4500_6000)*self.Xsection['ZToEE_4500_6000']   
#        elif self.sys_uncert == "pdf_6000_Inf_scale_up":
#            self.Xsection['ZToEE_6000_Inf']   =(1+self.DY_pdf_6000_Inf)*self.Xsection['ZToEE_6000_Inf']   
#        elif self.sys_uncert == "pdf_6000_Inf_scale_down":
#            self.Xsection['ZToEE_6000_Inf']   =(1-self.DY_pdf_6000_Inf)*self.Xsection['ZToEE_6000_Inf']   
        if self.sys_uncert == "bgk_ZToTT_scale_up":
            ...
            self.Xsection['WZ']             =  (1+self.Xsection_uncer["WZ"])*self.Xsection['WZ']          
            ...
            self.Xsection['ZZ']             =  (1+self.Xsection_uncer["ZZ"])*self.Xsection['ZZ']          
    ...
    def get_input_file(self):
        self.files['data']               =file_object('hist_data_RunBCDEFGH_reMiniAOD','data'       ,self.data_lumi      ,1     ,  ROOT.kBlack)
        if self.use_fewz_correct==False:
            self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120','Z#rightarrowee'          , 2846917.0, self.Xsection['ZToEE_50_120']    ,    ROOT.kGreen)
            self.files['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200','ZToEE_120_200'          , 99999.0,   self.Xsection['ZToEE_120_200']   ,    ROOT.kGreen)
            self.files['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400','ZToEE_200_400'          , 99200.0 ,  self.Xsection['ZToEE_200_400']   ,    ROOT.kGreen)
            self.files['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800','ZToEE_400_800'          , 99997.0,   self.Xsection['ZToEE_400_800']   ,    ROOT.kGreen)
            self.files['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400','ZToEE_800_1400'        , 100000.0,  self.Xsection['ZToEE_800_1400']  ,    ROOT.kGreen)
            self.files['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300','ZToEE_1400_2300'      , 100000.0,  self.Xsection['ZToEE_1400_2300'] ,    ROOT.kGreen)
            self.files['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500','ZToEE_2300_3500'      , 99999.0,   self.Xsection['ZToEE_2300_3500'] ,    ROOT.kGreen)
            self.files['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500','ZToEE_3500_4500'      , 99998.0,   self.Xsection['ZToEE_3500_4500'] ,    ROOT.kGreen)
            self.files['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000','ZToEE_4500_6000'      , 98999.0,   self.Xsection['ZToEE_4500_6000'] ,    ROOT.kGreen)
            self.files['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf','ZToEE_6000_Inf'        , 36598.0,   self.Xsection['ZToEE_6000_Inf']  ,    ROOT.kGreen)
        else:
            self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz','Z#rightarrowee'     , 2846917.0,  self.Xsection['ZToEE_50_120']   ,    ROOT.kGreen)
            self.files['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_fewz','ZToEE_120_200'     , 99999.0,    self.Xsection['ZToEE_120_200']  ,    ROOT.kGreen)
            self.files['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400_fewz','ZToEE_200_400'     , 99200.0 ,   self.Xsection['ZToEE_200_400']  ,    ROOT.kGreen)
            self.files['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_fewz','ZToEE_400_800'     , 99997.0,    self.Xsection['ZToEE_400_800']  ,    ROOT.kGreen)
            self.files['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400_fewz','ZToEE_800_1400'   , 100000.0,   self.Xsection['ZToEE_800_1400'] ,    ROOT.kGreen)
            self.files['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300_fewz','ZToEE_1400_2300' , 100000.0,   self.Xsection['ZToEE_1400_2300'],    ROOT.kGreen)
            self.files['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_fewz','ZToEE_2300_3500' , 99999.0,    self.Xsection['ZToEE_2300_3500'],    ROOT.kGreen)
            self.files['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_fewz','ZToEE_3500_4500' , 99998.0,    self.Xsection['ZToEE_3500_4500'],    ROOT.kGreen)
            self.files['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_fewz','ZToEE_4500_6000' , 98999.0,    self.Xsection['ZToEE_4500_6000'],    ROOT.kGreen)
            self.files['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_fewz','ZToEE_6000_Inf'   , 36598.0,    self.Xsection['ZToEE_6000_Inf'] ,    ROOT.kGreen)
        self.files['ZToTT_amc']          =file_object(self.str_uncert+'hist_ZToTT_amc','Z#rightarrow#tau#tau'       , 81589928,   self.Xsection['ZToTT_amc']      ,    ROOT.kCyan)
        if self.use_TTbar_MLL == False: 
            self.files['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_all','TTbar'                    , 78353860,   self.Xsection['TTbar']          ,    ROOT.kYellow)
        else:
            self.files['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_500','TTbar'                    , 78353860,   self.Xsection['TTbar']          ,    ROOT.kYellow)
            self.files['TTbar_500_800']  =file_object(self.str_uncert+'hist_TTbar2L_500_800','TTbar_500_800'        , 199979,     self.Xsection['TTbar_500_800']  ,    ROOT.kYellow)
            self.files['TTbar_800_1200'] =file_object(self.str_uncert+'hist_TTbar2L_800_1200','TTbar_800_1200'      , 199773,     self.Xsection['TTbar_800_1200'] ,    ROOT.kYellow)
            self.files['TTbar_1200_1800']=file_object(self.str_uncert+'hist_TTbar2L_1200_1800','TTbar_1200_1800'    , 199956,     self.Xsection['TTbar_1200_1800'],    ROOT.kYellow)
            self.files['TTbar_1800_Inf'] =file_object(self.str_uncert+'hist_TTbar2L_1800_Inf','TTbar_1800_Inf'      , 40816 ,     self.Xsection['TTbar_1800_Inf'] ,    ROOT.kYellow)
        self.files['WW']                 =file_object(self.str_uncert+'hist_WW2L_200','Di-Boson'                    , 1998956.0,  self.Xsection['WW']             ,    ROOT.kMagenta)
        self.files['WW_200_600']         =file_object(self.str_uncert+'hist_WW2L_200_600','WW2L_200_600'            , 199991.0,   self.Xsection['WW_200_600']     ,    ROOT.kMagenta)
        self.files['WW_600_1200']        =file_object(self.str_uncert+'hist_WW2L_600_1200','WW2L_600_1200'          , 199988.0,   self.Xsection['WW_600_1200']    ,    ROOT.kMagenta)
        self.files['WW_1200_2500']       =file_object(self.str_uncert+'hist_WW2L_1200_2500','WW2L_1200_2500'        , 199981.0,   self.Xsection['WW_1200_2500']   ,    ROOT.kMagenta)
        self.files['WW_2500_Inf']        =file_object(self.str_uncert+'hist_WW2L_2500_Inf','WW2L_2500_Inf'          , 38968.0,    self.Xsection['WW_2500_Inf']    ,    ROOT.kMagenta)
        self.files['WZ_2L2Q']            =file_object(self.str_uncert+'hist_WZ_2L2Q','WZ_2L2Q'                      , 15879128.0, self.Xsection['WZ_2L2Q']        ,    ROOT.kMagenta)
        self.files['WZ_3LNu']            =file_object(self.str_uncert+'hist_WZ_3LNu','WZ_3LNu'                      , 1993154.0 , self.Xsection['WZ_3LNu']        ,    ROOT.kMagenta)
        self.files['ZZ_2L2Nu']           =file_object(self.str_uncert+'hist_ZZ_2L2Nu','ZZ_2L2Nu'                    , 8842251.0,  self.Xsection['ZZ_2L2Nu']       ,    ROOT.kMagenta)
        self.files['ZZ_2L2Q']            =file_object(self.str_uncert+'hist_ZZ_2L2Q' ,'ZZ_2L2Q'                     , 496428.0,   self.Xsection['ZZ_2L2Q']        ,    ROOT.kMagenta)
        self.files['ZZ_4L']              =file_object(self.str_uncert+'hist_ZZ_4L'   ,'ZZ_4L'                       , 6617088.0,  self.Xsection['ZZ_4L']          ,    ROOT.kMagenta)
        self.files['ST']                 =file_object(self.str_uncert+'hist_ST','Single Top'                        , 3256548.0,  self.Xsection['ST']             ,    ROOT.kRed)
        self.files['ST_anti']            =file_object(self.str_uncert+'hist_ST_anti','ST_anti'                      , 3256309.0,  self.Xsection['ST_anti']        ,    ROOT.kRed)
        ############### tmp

        self.files_1F['data']               =file_object('hist_data_RunBCDEFGH_FR1F_reMiniAOD','data'     ,self.data_lumi      ,1     ,  ROOT.kBlack)
        if self.use_fewz_correct == False:
            self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_1F','Z#rightarrowee'          ,  2846917.0, self.Xsection['ZToEE_50_120']    ,     ROOT.kGreen)
            self.files_1F['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_1F','ZToEE_120_200'          ,  99999.0,   self.Xsection['ZToEE_120_200']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400_1F','ZToEE_200_400'          ,  99200.0 ,  self.Xsection['ZToEE_200_400']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_1F','ZToEE_400_800'          ,  99997.0,   self.Xsection['ZToEE_400_800']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400_1F','ZToEE_800_1400'        ,  100000.0,  self.Xsection['ZToEE_800_1400']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300_1F','ZToEE_1400_2300'      ,  100000.0,  self.Xsection['ZToEE_1400_2300'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_1F','ZToEE_2300_3500'      ,  99999.0,   self.Xsection['ZToEE_2300_3500'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_1F','ZToEE_3500_4500'      ,  99998.0,   self.Xsection['ZToEE_3500_4500'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_1F','ZToEE_4500_6000'      ,  98999.0,   self.Xsection['ZToEE_4500_6000'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_1F' ,'ZToEE_6000_Inf'       ,  36598.0,   self.Xsection['ZToEE_6000_Inf']  ,     ROOT.kGreen)
        else:                                                                                                                                              
            self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz_1F','Z#rightarrowee'     ,  2846917.0,  self.Xsection['ZToEE_50_120']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_fewz_1F','ZToEE_120_200'     ,  99999.0,    self.Xsection['ZToEE_120_200']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400_fewz_1F','ZToEE_200_400'     ,  99200.0 ,   self.Xsection['ZToEE_200_400']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_fewz_1F','ZToEE_400_800'     ,  99997.0,    self.Xsection['ZToEE_400_800']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400_fewz_1F','ZToEE_800_1400'   ,  100000.0,   self.Xsection['ZToEE_800_1400'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300_fewz_1F','ZToEE_1400_2300' ,  100000.0,   self.Xsection['ZToEE_1400_2300'],     ROOT.kGreen)
            self.files_1F['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_fewz_1F','ZToEE_2300_3500' ,  99999.0,    self.Xsection['ZToEE_2300_3500'],     ROOT.kGreen)
            self.files_1F['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_fewz_1F','ZToEE_3500_4500' ,  99998.0,    self.Xsection['ZToEE_3500_4500'],     ROOT.kGreen)
            self.files_1F['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_fewz_1F','ZToEE_4500_6000' ,  98999.0,    self.Xsection['ZToEE_4500_6000'],     ROOT.kGreen)
            self.files_1F['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_fewz_1F','ZToEE_6000_Inf'   ,  36598.0,    self.Xsection['ZToEE_6000_Inf'] ,     ROOT.kGreen)
        self.files_1F['ZToTT_amc']          =file_object(self.str_uncert+'hist_ZToTT_amc_1F','Z#rightarrow#tau#tau'       ,  81589928,   self.Xsection['ZToTT_amc']      ,     ROOT.kCyan)
        if self.use_TTbar_MLL == False:                                                                                                                         
            self.files_1F['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_all_1F','TTbar'                    ,  78353860,   self.Xsection['TTbar']          ,     ROOT.kYellow)
        else:                                                                                                                                              
            self.files_1F['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_500_1F','TTbar'                    ,  78353860,   self.Xsection['TTbar']          ,     ROOT.kYellow)
            self.files_1F['TTbar_500_800']  =file_object(self.str_uncert+'hist_TTbar2L_500_800_1F','TTbar_500_800'        ,  199979,     self.Xsection['TTbar_500_800']  ,     ROOT.kYellow)
            self.files_1F['TTbar_800_1200'] =file_object(self.str_uncert+'hist_TTbar2L_800_1200_1F','TTbar_800_1200'      ,  199773,     self.Xsection['TTbar_800_1200'] ,     ROOT.kYellow)
            self.files_1F['TTbar_1200_1800']=file_object(self.str_uncert+'hist_TTbar2L_1200_1800_1F','TTbar_1200_1800'    ,  199956,     self.Xsection['TTbar_1200_1800'],     ROOT.kYellow)
            self.files_1F['TTbar_1800_Inf'] =file_object(self.str_uncert+'hist_TTbar2L_1800_Inf_1F','TTbar_1800_Inf'      ,  40816 ,     self.Xsection['TTbar_1800_Inf'] ,     ROOT.kYellow)
        self.files_1F['WW']                 =file_object(self.str_uncert+'hist_WW2L_200_1F','Di-Boson'                    ,  1998956.0,  self.Xsection['WW']             ,     ROOT.kOrange+2)
        self.files_1F['WW_200_600']         =file_object(self.str_uncert+'hist_WW2L_200_600_1F','WW2L_200_600'            ,  199991.0,   self.Xsection['WW_200_600']     ,     ROOT.kOrange+2)
        self.files_1F['WW_600_1200']        =file_object(self.str_uncert+'hist_WW2L_600_1200_1F','WW2L_600_1200'          ,  199988.0,   self.Xsection['WW_600_1200']    ,     ROOT.kOrange+2)
        self.files_1F['WW_1200_2500']       =file_object(self.str_uncert+'hist_WW2L_1200_2500_1F','WW2L_1200_2500'        ,  199981.0,   self.Xsection['WW_1200_2500']   ,     ROOT.kOrange+2)
        self.files_1F['WW_2500_Inf']        =file_object(self.str_uncert+'hist_WW2L_2500_Inf_1F','WW2L_2500_Inf'          ,  38968.0,    self.Xsection['WW_2500_Inf']    ,     ROOT.kOrange+2)
        self.files_1F['WZ_2L2Q']            =file_object(self.str_uncert+'hist_WZ_2L2Q_1F','WZ_2L2Q'                      ,  15879128.0, self.Xsection['WZ_2L2Q']        ,     ROOT.kMagenta)
        self.files_1F['WZ_3LNu']            =file_object(self.str_uncert+'hist_WZ_3LNu_1F','WZ_3LNu'                      ,  1993154.0 , self.Xsection['WZ_3LNu']        ,     ROOT.kMagenta)
        self.files_1F['ZZ_2L2Nu']           =file_object(self.str_uncert+'hist_ZZ_2L2Nu_1F','ZZ_2L2Nu'                    ,  8842251.0,  self.Xsection['ZZ_2L2Nu']       ,     ROOT.kMagenta)
        self.files_1F['ZZ_2L2Q']            =file_object(self.str_uncert+'hist_ZZ_2L2Q_1F' ,'ZZ_2L2Q'                     ,  496428.0,   self.Xsection['ZZ_2L2Q']        ,     ROOT.kMagenta)
        self.files_1F['ZZ_4L']              =file_object(self.str_uncert+'hist_ZZ_4L_1F'   ,'ZZ_4L'                       ,  6617088.0,  self.Xsection['ZZ_4L']          ,     ROOT.kMagenta)
        self.files_1F['ST']                 =file_object(self.str_uncert+'hist_ST_1F','Single Top'                        ,  3256548.0,  self.Xsection['ST']             ,     ROOT.kRed)
        self.files_1F['ST_anti']            =file_object(self.str_uncert+'hist_ST_anti_1F','ST_anti'                      ,  3256309.0,  self.Xsection['ST_anti']        ,     ROOT.kRed)

        self.files_1F['QCD']                =file_object('hist_data_RunBCDEFGH_FR2F_reMiniAOD', 'QCD(data)'   ,self.data_lumi , 1                            ,     ROOT.kYellow-10)
    def get_lumi_normalized(self):
        ...
        other_hist=["h_pv_n","h_Ptll","h_Etall","h_Phill","h_led_Et","h_led_eta","h_led_phi","h_sub_Et","h_sub_eta","h_sub_phi","h_MET","h_MET_phi","h_MET_T1Txy","h_MET_phi_T1Txy","h_MET_SF_T1Txy","h_MET_Filter","h_Dphi_ll","h_Dphi_MET_Z","h_DR_ll","h_N_jet","h_N_bjet","h_HT_sys","h_Pt_sys","h_mee_Zpeak","h_mee_Zpeak_BB","h_mee_Zpeak_BE","h_mee_Zpeak_EE"]
    ...
    def get_jets_hist(self):
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/80X/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/all_m200/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0606_80X_v2/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0607/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0607_Z_match/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0607_sys/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0714_sys_sf/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0716_sys/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0716_sys_Mscale_m120/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/0717_Zmatch/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/no_PUreweight/"+self.str_uncert+"hist_jets.root","RECREATE")
        f_jets=ROOT.TFile("ntuples/sys_saved_hist/0805_genMatch/"+self.str_uncert+"hist_jets.root","RECREATE")
...
#System_list.append("lumi_scale_up")
#System_list.append("lumi_scale_down")
...
for nsys in System_list:
    System_uncertainty[nsys]=collcet_hist(nsys, True, True, nsys)
...
final_other_hist=["h_pv_n","h_Ptll","h_Etall","h_Phill","h_led_Et","h_led_eta","h_led_phi","h_sub_Et","h_sub_eta","h_sub_phi","h_MET","h_MET_phi","h_MET_T1Txy","h_MET_phi_T1Txy","h_MET_SF_T1Txy","h_MET_Filter","h_Dphi_ll","h_Dphi_MET_Z","h_DR_ll","h_N_jet","h_N_bjet","h_HT_sys","h_Pt_sys","h_mee_Zpeak","h_mee_Zpeak_BB","h_mee_Zpeak_BE","h_mee_Zpeak_EE"]
...
#################    print table 
    ...
    System_error={}
    #Mass_range_list=[[60,120],[120,400],[400,600],[600,900],[900,1300],[1300,1800],[1800,6000],[60,6000]]#for event list in different mass range.
    ...
    #Mass_range_list=[[2000,2100],[2100,2200],[2200,2300],[2300,2400],[2400,2500],[2500,2600],[2600,2700],[2700,2800],[2800,2900],[2900,3000],[2700,6000]]#for event list in different mass range.
