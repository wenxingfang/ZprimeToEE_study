...
samples['data_golden2015D'     ] = sample_object('data_BCDEFGH_reMiniAOD' , -1,-1, 'data', ROOT.kBlack)
samples['data_silverUp'        ] = sample_object('data_BCDEFGH_reMiniAOD' , -1,-1, 'data', ROOT.kBlack)
samples['data_silverDown'      ] = sample_object('data_BCDEFGH_reMiniAOD' , -1,-1, 'data', ROOT.kBlack)
samples['data_silver'          ] = sample_object('data_BCDEFGH_reMiniAOD' , -1,-1, 'data', ROOT.kBlack)
samples['data_silverNotGolden' ] = sample_object('data_BCDEFGH_reMiniAOD' , -1,-1, 'data', ROOT.kBlack)


#samples['ZToEE']   = sample_object('DYToEE_powheg'   ,   1921.8,  49668662.0, 'MCDY'   , ROOT.kGreen  )
samples['ZToTT']   = sample_object(       'ZToTT_mad',   5765.4,  46380395.0, 'MCOther', ROOT.kCyan   )

#samples['ZToEE']   = sample_object(      'DYToLL_mad',   5765.4,  46380395.0 , 'MCDY'   , ROOT.kGreen  )

#samples['ZToEE']   = sample_object(   'DYToLL_Zpt100',   5765.4,  46380395.0, 'MCDY'   , ROOT.kGreen  )
#samples['ZToEE_1'] = sample_object('DYToLL_Zpt100_200',  60.26,   5994550.0,  'MCDY'   , ROOT.kGreen  )
#samples['ZToEE_2'] = sample_object('DYToLL_Zpt200_Inf',  6.874,   2335240.0,  'MCDY'   , ROOT.kGreen  )

#samples['ZToEE']   = sample_object('DYToEE_mad_Zpt100_new',   5765.4,  46380395.0, 'MCDY'   , ROOT.kGreen  )
#samples['ZToEE_1'] = sample_object('DYToEE_mad_Zpt100_200',  60.26,   5994550.0,  'MCDY'   , ROOT.kGreen  )
#samples['ZToEE_2'] = sample_object('DYToEE_mad_Zpt200_Inf',  6.874,   2335240.0,  'MCDY'   , ROOT.kGreen  )
...
#samples['ZToEE']   = sample_object('DYToEE_amc_pt100_new',    5765.4,  77879147.0, 'MCDY'   , ROOT.kGreen  )
...
##samples['WJets']   = sample_object( 'WJet_amc_pt_100',61526.7, 16158081.0, 'MCOther', ROOT.kBlue   )
#samples['WJets']   = sample_object( 'WJet_amc_pt_100_new',61526.7, 16158081.0, 'MCOther', ROOT.kBlue   )
#samples['WJets_1'] = sample_object( 'WJet_amc_pt_100_250',676.3,   41283677.0, 'MCOther', ROOT.kBlue   )
#samples['WJets_2'] = sample_object( 'WJet_amc_pt_250_400',23.94,   4197759.0,  'MCOther', ROOT.kBlue   )
#samples['WJets_3'] = sample_object( 'WJet_amc_pt_400_600',3.031,   563638.0,   'MCOther', ROOT.kBlue   )
#samples['WJets_4'] = sample_object( 'WJet_amc_pt_600_Inf',0.4524,  787139.0,   'MCOther', ROOT.kBlue   )
...
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_pow_WJet_amc_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_pow_WJet_mad_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_amc_new_WJet_amc_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_amc_WJet_amc_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_amc_WJet_amc_old_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
samples['QCD'  ]  = sample_object(   'QCD_DYToEE_amc_new_WJet_mad_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_amc_pt100_WJet_mad_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
#samples['QCD'  ]  = sample_object(   'QCD_DYToEE_mad_WJet_mad_RunBCDEFGH_reMiniAOD' , 1.0, 35867,    'QCD', ROOT.kYellow-5)
