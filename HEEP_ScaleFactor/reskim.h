...
/*
   if(true==isWJets || true==isZToTT ){
     fChain->SetBranchAddress("mc_w_sign", &mc_w_sign, &b_mc_w_sign);
   }
*/   
   if(true==isData){
       if(triggerVersion.find("Ele27WPTight")!=string::npos ){
       fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_accept", &trig_fire, &b_trig_fire) ;
       fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_hltEle27erWPTightGsfTrackIsoFilter_eta", &trig_eta, &b_trig_eta) ;
       fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_hltEle27erWPTightGsfTrackIsoFilter_phi", &trig_phi, &b_trig_phi) ;
     }
