...
#include "turnonEle33_2017_ScaleSmear.C"
...
bool use_L1SingleEG=true;
bool use_L1DoubleEG=false;

bool use_scaled_sc_et=false;
...
TString output_dir="/user/wenxing/ST_TW_channel/CMSSW_9_4_0/src/Zprime/ntuples/sys_saved_hist/20180307_TT_WW_Check_sys/";
PU_data=pu_data;
...
t->GetEntry(i);
//std::cout<<"run:"<<ev_run<<",lumi:"<<ev_luminosityBlock<<",event:"<<ev_event<<std::endl;
ele_indexs.clear();
int is_pass_L1=0;
//////////////////////// MET Filter //////////
...
//if(heeps_et->at(j)<40 || heeps_et->at(k)<40)continue;//check >40, >40
