...
#include "turnonEle33_2018.C"
#include "turnonEle25_2018.C"
...
bool use_DoubleEle25=true;

bool use_gsf_sf=false;

bool LHE_Mass_cut=false;//using DYToEE_pow get 50-120 GeV

bool match_to_seed_led=false;// match electron to seeded leg of HLT to do a check

bool use_scaled_sc_et=false;// more correct way but don't use
...
TString input_dir ="/user/wenxing/ST_TW_channel/CMSSW_10_1_4/src/Zprime/reskim_script/reskim_out/for_plot/";
TString input_dir_100X ="/user/wenxing/ST_TW_channel/CMSSW_10_1_4/src/Zprime/reskim_script/reskim_out/for_plot/MC_100X/";
//TString input_dir ="/user/wenxing/ST_TW_channel/CMSSW_10_1_4/src/Zprime/reskim_script/reskim_out/for_plot/scale_smear_forEt45/";
TString output_dir="/user/wenxing/ST_TW_channel/CMSSW_10_1_4/src/Zprime/ntuples/sys_saved_hist/20180924_Z_Dele25/";
PU_data=pu_data;
...
if(PU_data=="Run_all"){
fill_hist(input_dir+"Run_all_38fb.root"   ,output_dir+"hist_data_MiniAOD.root"     ,"",true,false,false,false,false,uncertainty);
fill_hist(input_dir+"Run_all_38fb.root"   ,output_dir+"hist_data_FR1F_MiniAOD.root","",true,false,false,true ,false,uncertainty);
fill_hist(input_dir+"Run_all_38fb.root"   ,output_dir+"hist_data_FR2F_MiniAOD.root","",true,false,false,false ,true,uncertainty);
//fill_hist(input_dir+"Run_all.root"   ,output_dir+"hist_data_MiniAOD.root"     ,"",true,false,false,false,false,uncertainty);
//fill_hist(input_dir+"Run_all.root"   ,output_dir+"hist_data_FR1F_MiniAOD.root","",true,false,false,true ,false,uncertainty);
//fill_hist(input_dir+"Run_all.root"   ,output_dir+"hist_data_FR2F_MiniAOD.root","",true,false,false,false ,true,uncertainty);
//fill_hist(input_dir+"Run_all_scaled.root"   ,output_dir+"hist_data_MiniAOD.root"     ,"",true,false,false,false,false,uncertainty);
//fill_hist(input_dir+"Run_all_scaled.root"   ,output_dir+"hist_data_FR1F_MiniAOD.root","",true,false,false,true ,false,uncertainty);
//fill_hist(input_dir+"Run_all_scaled.root"   ,output_dir+"hist_data_FR2F_MiniAOD.root","",true,false,false,false ,true,uncertainty);
}
}
...
/*
fill_hist(input_dir_100X+   "DYToEE_pow.root"  ,output_dir+str_uncert+   "hist_ZToEE_50_120"+str_fewz+".root"   ,   "DYToEE_pow_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+   "DYToEE_pow.root"  ,output_dir+str_uncert+   "hist_ZToEE_50_120"+str_fewz+"_1F.root",   "DYToEE_pow_100X",false,true,do_fewz,true,false,uncertainty);
*/
/*
//fill_hist(input_dir_100X+   "ZToEE_50_120.root",output_dir+str_uncert+   "hist_ZToEE_50_120"+str_fewz+".root"   ,   "ZToEE_50_120_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+  "ZToEE_120_200.root",output_dir+str_uncert+  "hist_ZToEE_120_200"+str_fewz+".root"   ,  "ZToEE_120_200_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+  "ZToEE_200_400.root",output_dir+str_uncert+  "hist_ZToEE_200_400"+str_fewz+".root"   ,  "ZToEE_200_400_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+  "ZToEE_400_800.root",output_dir+str_uncert+  "hist_ZToEE_400_800"+str_fewz+".root"   ,  "ZToEE_400_800_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+ "ZToEE_800_1400.root",output_dir+str_uncert+ "hist_ZToEE_800_1400"+str_fewz+".root"   , "ZToEE_800_1400_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_1400_2300.root",output_dir+str_uncert+"hist_ZToEE_1400_2300"+str_fewz+".root"   ,"ZToEE_1400_2300_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_2300_3500.root",output_dir+str_uncert+"hist_ZToEE_2300_3500"+str_fewz+".root"   ,"ZToEE_2300_3500_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_3500_4500.root",output_dir+str_uncert+"hist_ZToEE_3500_4500"+str_fewz+".root"   ,"ZToEE_3500_4500_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_4500_6000.root",output_dir+str_uncert+"hist_ZToEE_4500_6000"+str_fewz+".root"   ,"ZToEE_4500_6000_100X",false,true,do_fewz,false,false,uncertainty);
fill_hist(input_dir_100X+ "ZToEE_6000_Inf.root",output_dir+str_uncert+ "hist_ZToEE_6000_Inf"+str_fewz+".root"   , "ZToEE_6000_Inf_100X",false,true,do_fewz,false,false,uncertainty);
//fill_hist(input_dir_100X+   "ZToEE_50_120.root",output_dir+str_uncert+   "hist_ZToEE_50_120"+str_fewz+"_1F.root",   "ZToEE_50_120_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+  "ZToEE_120_200.root",output_dir+str_uncert+  "hist_ZToEE_120_200"+str_fewz+"_1F.root",  "ZToEE_120_200_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+  "ZToEE_200_400.root",output_dir+str_uncert+  "hist_ZToEE_200_400"+str_fewz+"_1F.root",  "ZToEE_200_400_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+  "ZToEE_400_800.root",output_dir+str_uncert+  "hist_ZToEE_400_800"+str_fewz+"_1F.root",  "ZToEE_400_800_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+ "ZToEE_800_1400.root",output_dir+str_uncert+ "hist_ZToEE_800_1400"+str_fewz+"_1F.root", "ZToEE_800_1400_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_1400_2300.root",output_dir+str_uncert+"hist_ZToEE_1400_2300"+str_fewz+"_1F.root","ZToEE_1400_2300_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_2300_3500.root",output_dir+str_uncert+"hist_ZToEE_2300_3500"+str_fewz+"_1F.root","ZToEE_2300_3500_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_3500_4500.root",output_dir+str_uncert+"hist_ZToEE_3500_4500"+str_fewz+"_1F.root","ZToEE_3500_4500_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+"ZToEE_4500_6000.root",output_dir+str_uncert+"hist_ZToEE_4500_6000"+str_fewz+"_1F.root","ZToEE_4500_6000_100X",false,true,do_fewz,true,false,uncertainty);
fill_hist(input_dir_100X+ "ZToEE_6000_Inf.root",output_dir+str_uncert+ "hist_ZToEE_6000_Inf"+str_fewz+"_1F.root", "ZToEE_6000_Inf_100X",false,true,do_fewz,true,false,uncertainty);
*/
...
fill_hist(input_dir+"WW_200.root"         ,output_dir+str_uncert+"hist_WW_200.root"                        ,"WW"             ,false,false,false,false,false,uncertainty);
fill_hist(input_dir+"TTTo2L2Nu_500.root"  ,output_dir+str_uncert+"hist_TTbar2L_500.root"                   ,"TT_2L2Nu"       ,false,false,false,false,false,uncertainty);
...
fill_hist(input_dir+"WW_200.root"         ,output_dir+str_uncert+"hist_WW_200_1F.root"                      ,"WW"           ,false,false,false,true,false,uncertainty);
fill_hist(input_dir+"TTTo2L2Nu_500.root"  ,output_dir+str_uncert+"hist_TTbar2L_500_1F.root"                 ,"TT_2L2Nu"     ,false,false,false,true,false,uncertainty);
...
e1_pass_trigger=trigEle33::passTrig(heeps_et->at(j), heeps_sc_eta->at(j), PU_data) ;
//e1_match_L1    = use_scaled_sc_et ? trigEle33l1::passTrig(heeps_sc_et_corr->at(j),heeps_sc_eta->at(j),PU_data, use_scaled_sc_et) : trigEle33l1::passTrig(heeps_sc_et->at(j),heeps_sc_eta->at(j),PU_data, false) ;
    }
//////////// just check//
//e1_pass_trigger=1;///////
/////////////////////////
...
e2_pass_trigger=trigEle33::passTrig(heeps_et->at(k), heeps_sc_eta->at(k), PU_data) ;
//e2_match_L1    = use_scaled_sc_et ? trigEle33l1::passTrig(heeps_sc_et_corr->at(k),heeps_sc_eta->at(k),PU_data, use_scaled_sc_et) : trigEle33l1::passTrig(heeps_sc_et->at(k),heeps_sc_eta->at(k),PU_data, false) ;
    }
//////////// just check//
//e2_pass_trigger=1;///////
/////////////////////////
...
//if(use_L1SingleEG) {if(e1_match_L1==0 && e2_match_L1==0) continue;}//for L1 SingleEG matching
//if(use_L1DoubleEG) {if(L1_pass_final==0) continue;}//for L1 DoubleEG matching
//if(heeps_et->at(j)<45 || heeps_et->at(k)<45)continue;//check >45, >45
...
//if(is_pass_L1==0)std::cout<<"ev_event="<<ev_event<<",L1 size="<<trig_DEle33_MW_L1_eta->size()<<"HEEP1 Et="<<heeps_et->at(index_1)<<"HEEP2 Et="<<heeps_et->at(index_2)<<std::endl;
}
}//else
...
if(LHE_Mass_cut && LHE_Z_mass>120)continue;//for test
                           }//for match check
...
//////////////////////// PU ///////////////////////////
if(do_PU_weight==true) {                                 event_weight=event_sign*PU_2018::MC_pileup_weight(PU_true,pu_name,PU_data          );
                        if(uncert=="PU_scale_up")        event_weight=event_sign*PU_2018::MC_pileup_weight(PU_true,pu_name,PU_data+TString("_scaleUp"  ));
                        else if(uncert=="PU_scale_down") event_weight=event_sign*PU_2018::MC_pileup_weight(PU_true,pu_name,PU_data+TString("_scaleDown"));
                       }
...
event_weight=event_weight*fake_rate*fewz_weight*sf_weight(e1_et, e1_sc_eta,uncert)*sf_weight(e2_et, e2_sc_eta,uncert)*pdf_weight*sf_gsf_weight;
...
for(unsigned int i=0;i<filter_eta->size();i++){
tmp2.SetPtEtaPhiM(1,filter_eta->at(i),filter_phi->at(i),0);
//std::cout<<"eta HEEP="<<eta<<",phi HEEP="<<phi<<",L1 eta="<<filter_eta->at(i)<<",L1 phi="<<filter_phi->at(i)<<",L1 et="<<filter_et->at(i)<<", run="<<runnr<<", LS="<<lumisec<<", L1 threshold="<<float(getLowestSingleL1EG(runnr,lumisec))<<std::endl;
