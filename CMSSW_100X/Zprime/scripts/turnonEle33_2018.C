...
*/
    ...
    if (0.0<=fabs(scEta) && fabs(scEta)<0.79)
      return turnOnfunction(scEt,0.8983, 33.95, 0.4226, 0.08029, 34.82, 2.415);
    else if (0.79<=fabs(scEta) && fabs(scEta)<1.1)
      return turnOnfunction(scEt,0.8675, 33.98, 0.4748, 0.1109, 34.64, 2.397);
    else if (1.1<=fabs(scEta) && fabs(scEta)<1.4442)
      return turnOnfunction(scEt,0.8754, 34.18, 0.6593, 0.09724, 34.12, 2.638);
    else if (1.566<=fabs(scEta) && fabs(scEta)<1.70)
      return turnOnfunction(scEt,0.809, 33.69, 0.7076, 0.1619, 33.83, 2.569);
    else if (1.70<=fabs(scEta) && fabs(scEta)<2.1)
      return turnOnfunction(scEt,0.7657, 33.96, 0.6775, 0.2207, 34.12, 1.754);
    else if (2.1<=fabs(scEta) && fabs(scEta)<2.5)
      return turnOnfunction(scEt,0.5857, 35.01, 0.9039, 0.3945, 35.67, 1.638);
    else
      return -1.0;
       }
