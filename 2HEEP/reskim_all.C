...
/*
    ...
    reskim reskim_data_1(ch_data_1, true, false, false, false, 3, 273158, 274442) ;
    reskim_data_1.Loop("ntuples/reskim/data_12p39fb_v3_1.root") ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_2(ch_data_2, true, false, false, false, 3, 273158, 274442) ;
    reskim_data_2.Loop("ntuples/reskim/data_12p39fb_v3_2.root") ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_3(ch_data_3, true, false, false, false, 4, 274954, 275066) ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_4(ch_data_4, true, false, false, false, 5, 275067, 275311) ;
    reskim_data_4.Loop("ntuples/reskim/data_12p39fb_v5.root") ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_5(ch_data_5, true, false, false, false, 6, 275319, 276811) ;
    reskim_data_5.Loop("ntuples/reskim/data_12p39fb_v6_1.root") ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_6(ch_data_6, true, false, false, false, 6, 275319, 276811) ;
    reskim_data_6.Loop("ntuples/reskim/data_12p39fb_v6_2.root") ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_7(ch_data_7, true, false, false, false, 6, 275319, 276811) ;
    reskim_data_7.Loop("ntuples/reskim/data_12p39fb_v6_3.root") ;
*/
...
//    }
//    cout << "Add file finish: " << endl; 
//    reskim reskim_data_8(ch_data_8, true, false, false, false, 6, 276830, 276834) ;
//    reskim_data_8.Loop("ntuples/reskim/RunE/data_RunE_v6.root") ;
//
...
//    }
//    cout << "Add file finish: " << endl; 
//    reskim reskim_data_9(ch_data_9, true, false, false, false, 7, 276870, 277420) ;
//    reskim_data_9.Loop("ntuples/reskim/RunE/data_RunE_v7.root") ;
...
/*
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_F_1(ch_data_F_1, true, false, false, false, 7, 277820, 278240) ;
    reskim_data_F_1.Loop("ntuples/reskim/RunF/data_RunF_v7.root") ;
    ...
    cout << "Add file finish: " << endl; 
    reskim reskim_data_F_2(ch_data_F_2, true, false, false, false, 8, 278273, 278808) ;
    reskim_data_F_2.Loop("ntuples/reskim/RunF/data_RunF_v8.root") ;
*/
//---------------------------- RunG ---------------------------------------
...
//    cout << "Add file finish: " << endl; 
//    reskim reskim_data_G(ch_data_G, true, false, false, false, 9, 1, 1000000) ;
//    reskim_data_G.Loop("ntuples/reskim/RunG/data_RunG_Ele33MW.root") ;


    TChain *ch_data_test =new TChain("IIHEAnalysis");
    ch_data_test->Add("/pnfs/iihe/cms/store/user/rgoldouz/DoubleEG/crab_DoubleEG_Run2016B-23Sep2016-v3_AOD/161204_183245/0000/outfile_1.root");
    cout << "Add file finish: " << endl; 
    reskim reskim_data_test(ch_data_test, true, false, false, false, "DoubleEle33_CaloIdL_MW" , 273158 , 275376) ;
    reskim_data_test.Loop("ntuples/reskim/test.root") ;
...
//
    ...
    ch_TT2L_1->Add("/pnfs/iihe/cms/store/user/wenxing/MC_PUMoriond17/MiniAOD/TTTo2L2Nu_noSC_TuneCUETP8M2T4_13TeV-powheg-pythia8/crab_TTTo2L2Nu_noSC_TuneCUETP8M2T4_13TeV-powheg-MiniAOD/170117_095116/0000/*.root") ;
    ...
    ch_WW2L_1->Add("/pnfs/iihe/cms/store/user/xgao/2017MC_Moriond/MINIAOD/WWTo2L2Nu_13TeV-powheg/crab_WWTo2L2Nu/170116_152718/0000/*.root") ;
...
//    reskim reskim_ZToEE_1(ch_ZToEE_1, false, false, false, false) ;
//    reskim_ZToEE_1.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_50_120.root") ;
//    reskim reskim_ZToEE_2(ch_ZToEE_2, false, false, false, false) ;
//    reskim_ZToEE_2.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_120_200.root") ;
//    reskim reskim_ZToEE_3(ch_ZToEE_3, false, false, false, false) ;
//    reskim_ZToEE_3.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_200_400.root") ;
//    reskim reskim_ZToEE_4(ch_ZToEE_4, false, false, false, false) ;
//    reskim_ZToEE_4.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_400_800.root") ;
//    reskim reskim_ZToEE_5(ch_ZToEE_5, false, false, false, false) ;
//    reskim_ZToEE_5.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_800_1400.root") ;
//    reskim reskim_ZToEE_6(ch_ZToEE_6, false, false, false, false) ;
//    reskim_ZToEE_6.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_1400_2300.root") ;
//    reskim reskim_ZToEE_7(ch_ZToEE_7, false, false, false, false) ;
//    reskim_ZToEE_7.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_2300_3500.root") ;
//    reskim reskim_ZToEE_8(ch_ZToEE_8, false, false, false, false) ;
//    reskim_ZToEE_8.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_3500_4500.root") ;
//    reskim reskim_ZToEE_9(ch_ZToEE_9, false, false, false, false) ;
//    reskim_ZToEE_9.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_4500_6000.root") ;
//    reskim reskim_ZToEE_10(ch_ZToEE_10, false, false, false, false) ;
//    reskim_ZToEE_10.Loop("ntuples/reskim/RunE/ZToEE_powheg_M_6000_Inf.root") ;
//
//    reskim reskim_DY_1(ch_DY_1, false, false, true, false) ;
//    reskim_DY_1.Loop("ntuples/reskim/RunE/ZToTT_mad_1.root") ;
//    reskim reskim_DY_2(ch_DY_2, false, false, true, false) ;
//    reskim_DY_2.Loop("ntuples/reskim/RunE/ZToTT_mad_2.root") ;
//    reskim reskim_DY_3(ch_DY_3, false, false, true, false) ;
//    reskim_DY_3.Loop("ntuples/reskim/RunE/ZToTT_mad_3.root") ;
//    
//    reskim reskim_WJet_mad_1(ch_WJet_mad_1, false, false, false, false) ;
//    reskim_WJet_mad_1.Loop("ntuples/reskim/RunE/WJet_mad_1.root") ;
//    reskim reskim_WJet_mad_2(ch_WJet_mad_2, false, false, false, false) ;
//    reskim_WJet_mad_2.Loop("ntuples/reskim/RunE/WJet_mad_2.root") ;
//
//    reskim reskim_WZ(ch_WZ, false, false, false, false) ;
//    reskim_WZ.Loop("ntuples/reskim/RunE/WZ.root") ;
//    reskim reskim_ZZ(ch_ZZ, false, false, false, false) ;
//    reskim_ZZ.Loop("ntuples/reskim/RunE/ZZ.root") ;
//    reskim reskim_ST(ch_ST, false, false, false, false) ;
//    reskim_ST.Loop("ntuples/reskim/RunE/ST.root") ;
//    reskim reskim_ST_anti(ch_ST_anti, false, false, false, false) ;
//    reskim_ST_anti.Loop("ntuples/reskim/RunE/ST_anti.root") ;
//    reskim reskim_GJ_1(ch_GJ_1, false, false, false, false) ;
//    reskim_GJ_1.Loop("ntuples/reskim/RunE/GJ_40_100.root") ;
//    reskim reskim_GJ_2(ch_GJ_2, false, false, false, false) ;
//    reskim_GJ_2.Loop("ntuples/reskim/RunE/GJ_100_200.root") ;
//    reskim reskim_GJ_3(ch_GJ_3, false, false, false, false) ;
//    reskim_GJ_3.Loop("ntuples/reskim/RunE/GJ_200_400.root") ;
//    reskim reskim_GJ_4(ch_GJ_4, false, false, false, false) ;
//    reskim_GJ_4.Loop("ntuples/reskim/RunE/GJ_400_600.root") ;
//    reskim reskim_GJ_5(ch_GJ_5, false, false, false, false) ;
//    reskim_GJ_5.Loop("ntuples/reskim/RunE/GJ_600_Inf.root") ;


    reskim reskim_TT2L_1(ch_TT2L_1, false, true, false, false) ;
    reskim_TT2L_1.Loop("ntuples/reskim/ttbar_test.root") ;

    reskim reskim_WW2L_1(ch_WW2L_1, false, false, false, true) ;
    reskim_WW2L_1.Loop("ntuples/reskim/WW2L_test.root") ;
//    reskim reskim_WW2L_2(ch_WW2L_2, false, false, false, false) ;
//    reskim_WW2L_2.Loop("ntuples/reskim/RunE/WW2L_200_600.root") ;
//    reskim reskim_WW2L_3(ch_WW2L_3, false, false, false, false) ;
//    reskim_WW2L_3.Loop("ntuples/reskim/RunE/WW2L_600_1200.root") ;
//    reskim reskim_WW2L_4(ch_WW2L_4, false, false, false, false) ;
//    reskim_WW2L_4.Loop("ntuples/reskim/RunE/WW2L_1200_2500.root") ;
//    reskim reskim_WW2L_5(ch_WW2L_5, false, false, false, false) ;
//    reskim_WW2L_5.Loop("ntuples/reskim/RunE/WW2L_2500_Inf.root") ;

/*
    reskim reskim_DY_1(ch_DY_1, false, true, false, false) ;
    reskim_DY_1.Loop("ntuples/reskim/DYToEE_mad_1.root") ;
    reskim reskim_DY_2(ch_DY_2, false, true, false, false) ;
    reskim_DY_2.Loop("ntuples/reskim/DYToEE_mad_2.root") ;
    reskim reskim_DY_3(ch_DY_3, false, true, false, false) ;
    reskim_DY_3.Loop("ntuples/reskim/DYToEE_mad_3.root") ;

    reskim reskim_DYToEE_1(ch_DYToEE_1, false, false, false, false) ;
    reskim_DYToEE_1.Loop("ntuples/reskim/DYToEE_pow_1.root") ;
    reskim reskim_DYToEE_2(ch_DYToEE_2, false, false, false, false) ;
    reskim_DYToEE_2.Loop("ntuples/reskim/DYToEE_pow_2.root") ;
    reskim reskim_DYToEE_3(ch_DYToEE_3, false, false, false, false) ;
    reskim_DYToEE_3.Loop("ntuples/reskim/DYToEE_pow_3.root") ;

    reskim reskim_DY_amc_1(ch_DY_amc_1, false, true, false, false) ;
    reskim_DY_amc_1.Loop("ntuples/reskim/DYToEE_amc_1.root") ;
    reskim reskim_DY_amc_2(ch_DY_amc_2, false, true, false, false) ;
    reskim_DY_amc_2.Loop("ntuples/reskim/DYToEE_amc_2.root") ;
*/
  }
