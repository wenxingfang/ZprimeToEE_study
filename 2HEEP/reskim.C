...
void reskim::Loop(TString fname){
   ...
   int   e1_pass_VIDHEEP7    = 0 ;
   int   e2_pass_VIDHEEP7    = 0 ;
   int   e1_isHEEP    = 0 ;
   int   e2_isHEEP    = 0 ;
   float e1_dPhiIn           = 0 ;
   float e1_Sieie            = 0 ;
   ...
   int ev_particleFlowEGammaGSFixed_out=0;
   UInt_t ev_run_out=0;
   UInt_t ev_event_out=0;
   UInt_t ev_luminosityBlock_out=0; 
   tree_out.Branch("ev_run"    , &ev_run_out        , "ev_run/i"      ) ;
   tree_out.Branch("ev_event"  , &ev_event_out      , "ev_event/i"      ) ;
   tree_out.Branch("ev_luminosityBlock"  , &ev_luminosityBlock_out      , "ev_luminosityBlock/i"      ) ;
   ...
   tree_out.Branch("ev_particleFlowEGammaGSFixed", &ev_particleFlowEGammaGSFixed_out        , "ev_particleFlowEGammaGSFixed/I"  ) ;
   ...
   tree_out.Branch("e1_pass_VIDHEEP7"   , &e1_pass_VIDHEEP7   , "e1_pass_VIDHEEP7/I"       ) ;
   tree_out.Branch("e2_pass_VIDHEEP7"   , &e2_pass_VIDHEEP7   , "e2_pass_VIDHEEP7/I"       ) ;
   ...
   TTree tree_VIDHEEP7("Ele_VIDHEEP7","HEEP ele") ;
   tree_VIDHEEP7.Branch("ev_run"    , &ev_run_out        , "ev_run/i"      ) ;
   tree_VIDHEEP7.Branch("ev_event"  , &ev_event_out      , "ev_event/i"      ) ;
   tree_VIDHEEP7.Branch("ev_luminosityBlock"  , &ev_luminosityBlock_out      , "ev_luminosityBlock/i"      ) ;
   tree_VIDHEEP7.Branch("trig_Flag_METFilters_accept", &trig_Flag_METFilters_out        , "trig_Flag_METFilters_accept/I"  ) ;
   tree_VIDHEEP7.Branch("ev_particleFlowEGammaGSFixed", &ev_particleFlowEGammaGSFixed_out        , "ev_particleFlowEGammaGSFixed/I"  ) ;
   tree_VIDHEEP7.Branch("PU_true"   , &PU_true_out       , "PU_true/I"     ) ;
   tree_VIDHEEP7.Branch("event_sign", &event_sign        , "event_sign/I"  ) ;
   tree_VIDHEEP7.Branch("mee"       , &mee_out           , "mee/F"      ) ;
   tree_VIDHEEP7.Branch("e1_isHEEP" , &e1_isHEEP         , "e1_isHEEP/I"    ) ;
   tree_VIDHEEP7.Branch("e2_isHEEP" , &e2_isHEEP         , "e2_isHEEP/I"    ) ;
   tree_VIDHEEP7.Branch("e1_Et"     , &HEEP1_Et_out      , "e1_Et/F"    ) ;
   tree_VIDHEEP7.Branch("e1_eta"    , &HEEP1_eta_out     , "e1_eta/F"   ) ;
   tree_VIDHEEP7.Branch("e1_phi"    , &HEEP1_phi_out     , "e1_phi/F"   ) ;
   tree_VIDHEEP7.Branch("e2_Et"     , &HEEP2_Et_out      , "e2_Et/F"    ) ;
   tree_VIDHEEP7.Branch("e2_eta"    , &HEEP2_eta_out     , "e2_eta/F"   ) ;
   tree_VIDHEEP7.Branch("e2_phi"    , &HEEP2_phi_out     , "e2_phi/F"   ) ;
   tree_VIDHEEP7.Branch("w_PU_combined"   , &w_PU_combined_out , "w_PU_combined/F"         ) ;
   tree_VIDHEEP7.Branch("mee_gsf"   , &mee_out_gsf       , "mee_gsf/F"      ) ;
   tree_VIDHEEP7.Branch("e1_eta_gsf", &HEEP1_eta_out_gsf , "e1_eta_gsf/F") ;
   tree_VIDHEEP7.Branch("e1_phi_gsf", &HEEP1_phi_out_gsf , "e1_phi_gsf/F") ;
   tree_VIDHEEP7.Branch("e2_eta_gsf", &HEEP2_eta_out_gsf , "e2_eta_gsf/F") ;
   tree_VIDHEEP7.Branch("e2_phi_gsf", &HEEP2_phi_out_gsf , "e2_phi_gsf/F") ;
...
//   displayProgress(jentry, nentries) ;
   ...
   ev_particleFlowEGammaGSFixed_out=int(ev_particleFlowEGammaGSFixed);
      int w_sign = 1 ;
...
//####################################################          
        ...
        el->pass_VIDHEEP7 = int(gsf_VIDHEEP7->at(iEl)) ;
...
//#######################################
      ...
      if(false==e1->accept_HEEP_ID || false==e1->pass_trigger) continue ;
        
      for(unsigned int i_2=i_1+1 ; i_2<electrons.size() ; ++i_2){
      electron_candidate* e2 = electrons.at(i_2) ;
      if(false==e2->accept_HEEP_ID || false==e2->pass_trigger) continue ;
      float Sum_Et=e1->Et + e2->Et;
      if(Sum_Et < Sum_Et_max) continue;
      Sum_Et_max             = Sum_Et     ;
      ...
      e1_pass_VIDHEEP7      = e1->pass_VIDHEEP7      ;
      e2_pass_VIDHEEP7      = e2->pass_VIDHEEP7      ;
      ...
      if(Sum_Et_max!=0)tree_out.Fill() ;
//// For VIDHEEP7 //////////////////////////////
      Sum_Et_max=0;
      for(unsigned int i_1=0 ; i_1<electrons.size() ; ++i_1){
      electron_candidate* e1 = electrons.at(i_1) ;
      if(e1->Et<=35 || false==e1->pass_VIDHEEP7 || false==e1->pass_trigger) continue ;
      for(unsigned int i_2=i_1+1 ; i_2<electrons.size() ; ++i_2){
      electron_candidate* e2 = electrons.at(i_2) ;
      if(e2->Et<=35 || false==e2->pass_VIDHEEP7 || false==e2->pass_trigger) continue ;
      float Sum_Et=e1->Et + e2->Et;
      if(Sum_Et < Sum_Et_max) continue;
      Sum_Et_max             = Sum_Et     ;
      TLorentzVector Zp4     = e1->p4 + e2->p4 ;
      mee_out                = Zp4.M() ;
      e1_isHEEP              = e1->accept_HEEP_ID;
      e2_isHEEP              = e2->accept_HEEP_ID;
      HEEP1_Et_out           = e1->Et  ;
      HEEP1_eta_out          = e1->eta ;
      HEEP1_phi_out          = e1->phi ;
      HEEP2_Et_out           = e2->Et  ;
      ...
      if(Sum_Et_max!=0)tree_VIDHEEP7.Fill() ;

//// For energy scale uncertainty /////////////////

      Sum_Et_max=0;
      for(unsigned int i_1=0 ; i_1<electrons_Barrel_scale_up.size() ; ++i_1){
      electron_candidate* e1 = electrons_Barrel_scale_up.at(i_1) ;
      if(false==e1->accept_HEEP_ID || false==e1->pass_trigger) continue ;
      for(unsigned int i_2=i_1+1 ; i_2<electrons_Barrel_scale_up.size() ; ++i_2){
      ...
      if(Sum_Et_max!=0)tree_Endcap_scale_down.Fill() ;
//////////////////////////////////////////////////
