...
#ifndef reskim_FR_2F_h
#define reskim_FR_2F_h
...
//   int triggerVersion ;
   ...
   reskim_FR_2F(TTree *tree=0, bool isData_in=false, bool isTTbar_in=false, bool isZToTT_in=false, bool isWW_in=false, string triggerVersion_in="", int Run_low_in=0, int Run_high_in=999999);
   virtual ~reskim_FR_2F();
...
#ifdef reskim_FR_2F_cxx
reskim_FR_2F::reskim_FR_2F(TTree *tree, bool isData_in, bool isTTbar_in,  bool isZToTT_in, bool isWW_in, string triggerVersion_in, int Run_low_in, int Run_high_in) :
fChain(0),
goldenLumi(2040.0), 
silverLumi(351.0), 
combinedLumi(2391.0)
...
reskim_FR_2F::~reskim_FR_2F()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t reskim_FR_2F::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t reskim_FR_2F::LoadTree(Long64_t entry)
{
...
void reskim_FR_2F::Init(TTree *tree)
{
...
void reskim_FR_2F::Show(Long64_t entry)
{
...
Int_t reskim_FR_2F::Cut(Long64_t entry)
{
