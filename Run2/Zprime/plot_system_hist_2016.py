...
#    canvas.SaveAs('%s/%s/%s.root'%(out_dir,date,out_name))    
    ...
    #if out_name in ["h_mee_all",'h_mee_all_BB','h_mee_all_BE','h_mee_all_EE'] and True:
    if out_name in ["h_mee_all",'h_mee_all_BB','h_mee_all_BE','h_mee_all_EE','h_mee_all_cumlative_v1','h_mee_all_cumlative_BE_v1','h_mee_all_cumlative_BB_v1','h_mee_all_cumlative_EE_v1'] and True:
        ...
        print h_jets_mee
        ####### for combine result ###################
        f_comb= ROOT.TFile("Result_2016.root","update")
        f_comb.cd()
        ...
        f_HEPData= ROOT.TFile("HEPData_2016.root","update")
        f_HEPData.cd()
...
#    ################ Fit background ####################
    ...
    if out_name in ["h_mee_usual","h_mee_BB_usual","h_mee_BE_usual"] and True:
        f_bgk_out= ROOT.TFile("bgk_2016.root","UPDATE");
        f_bgk_out.cd()
...
class file_object:
    def __init__(self, file_name, name, event, crosssection, color):
        ...
        #self.tfilename = 'ntuples/sys_saved_hist/2016/20190621_GenM/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2016/20190703_fr_MasScale/all/%s.root'%(self.file_name)
        self.tfilename = 'ntuples/sys_saved_hist/2016/20190704_newBin/all/%s.root'%(self.file_name)
...
#        self.DY_pdf_6000_Inf =DY_pdf_new(6000,7500)
    ...
    def get_input_file(self):
        ...
        if self.use_fewz_correct==False:
            self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120','Z#rightarrowee'          , 2998400.0,  self.Xsection['ZToEE_50_120']    ,    ROOT.kGreen)
            self.files['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200','ZToEE_120_200'          , 100000.0,   self.Xsection['ZToEE_120_200']   ,    ROOT.kGreen)
            ...
            self.files['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800','ZToEE_400_800'          , 100000.0,   self.Xsection['ZToEE_400_800']   ,    ROOT.kGreen)
            ...
            self.files['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500','ZToEE_2300_3500'      , 100000.0,   self.Xsection['ZToEE_2300_3500'] ,    ROOT.kGreen)
            self.files['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500','ZToEE_3500_4500'      , 100000.0,   self.Xsection['ZToEE_3500_4500'] ,    ROOT.kGreen)
            self.files['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000','ZToEE_4500_6000'      , 99000.0,    self.Xsection['ZToEE_4500_6000'] ,    ROOT.kGreen)
            self.files['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf','ZToEE_6000_Inf'        , 99800.0,    self.Xsection['ZToEE_6000_Inf']  ,    ROOT.kGreen)
        else:
            self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz','Z#rightarrowee'     , 2998400.0,  self.Xsection['ZToEE_50_120']   ,    ROOT.kGreen)
            self.files['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_fewz','ZToEE_120_200'     , 100000.0,   self.Xsection['ZToEE_120_200']  ,    ROOT.kGreen)
            ...
            self.files['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_fewz','ZToEE_400_800'     , 100000.0,   self.Xsection['ZToEE_400_800']  ,    ROOT.kGreen)
            ...
            self.files['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_fewz','ZToEE_2300_3500' , 100000.0,   self.Xsection['ZToEE_2300_3500'],    ROOT.kGreen)
            self.files['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_fewz','ZToEE_3500_4500' , 100000.0,   self.Xsection['ZToEE_3500_4500'],    ROOT.kGreen)
            self.files['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_fewz','ZToEE_4500_6000' , 99000.0,    self.Xsection['ZToEE_4500_6000'],    ROOT.kGreen)
            self.files['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_fewz','ZToEE_6000_Inf'   , 99800.0,    self.Xsection['ZToEE_6000_Inf'] ,    ROOT.kGreen)
        self.files['ZToTT_amc']          =file_object(self.str_uncert+'hist_ZToTT','Z#rightarrow#tau#tau'             , 29137162.0, self.Xsection['ZToTT_amc']      ,    ROOT.kCyan)
        if self.use_TTbar_MLL == False: 
            self.files['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_all','TTbar'                      , 79140880.0, self.Xsection['TTbar']          ,    ROOT.kYellow)
        else:
            self.files['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_500','TTbar'                      , 79140880,   self.Xsection['TTbar']          ,    ROOT.kYellow)
            self.files['TTbar_500_800']  =file_object(self.str_uncert+'hist_TTbar2L_500_800','TTbar_500_800'          , 200000,     self.Xsection['TTbar_500_800']  ,    ROOT.kYellow)
            self.files['TTbar_800_1200'] =file_object(self.str_uncert+'hist_TTbar2L_800_1200','TTbar_800_1200'        , 199800,     self.Xsection['TTbar_800_1200'] ,    ROOT.kYellow)
            self.files['TTbar_1200_1800']=file_object(self.str_uncert+'hist_TTbar2L_1200_1800','TTbar_1200_1800'      , 200000,     self.Xsection['TTbar_1200_1800'],    ROOT.kYellow)
            self.files['TTbar_1800_Inf'] =file_object(self.str_uncert+'hist_TTbar2L_1800_Inf','TTbar_1800_Inf'        , 40829 ,     self.Xsection['TTbar_1800_Inf'] ,    ROOT.kYellow)
        self.files['ST']                 =file_object(self.str_uncert+'hist_ST','Single Top'                          , 8681495.0,  self.Xsection['ST']             ,    ROOT.kRed)
        self.files['ST_anti']            =file_object(self.str_uncert+'hist_ST_anti','ST_anti'                        , 8681541.0,  self.Xsection['ST_anti']        ,    ROOT.kRed)
        if self.use_WW_MLL == False: 
            self.files['WW']                 =file_object(self.str_uncert+'hist_WW','Di-Boson'                        , 1999000.0,  self.Xsection['WW_inc']         ,    ROOT.kMagenta)
        else:
            self.files['WW']                 =file_object(self.str_uncert+'hist_WW2L_200','Di-Boson'                  , 1999000.0,  self.Xsection['WW']             ,    ROOT.kMagenta)
            self.files['WW_200_600']         =file_object(self.str_uncert+'hist_WW2L_200_600','WW2L_200_600'          , 200000.0,   self.Xsection['WW_200_600']     ,    ROOT.kMagenta)
            self.files['WW_600_1200']        =file_object(self.str_uncert+'hist_WW2L_600_1200','WW2L_600_1200'        , 200000.0,   self.Xsection['WW_600_1200']    ,    ROOT.kMagenta)
            self.files['WW_1200_2500']       =file_object(self.str_uncert+'hist_WW2L_1200_2500','WW2L_1200_2500'      , 200000.0,   self.Xsection['WW_1200_2500']   ,    ROOT.kMagenta)
            self.files['WW_2500_Inf']        =file_object(self.str_uncert+'hist_WW2L_2500_Inf','WW2L_2500_Inf'        , 38969.0,    self.Xsection['WW_2500_Inf']    ,    ROOT.kMagenta)
        self.files['WZ_2L2Q']            =file_object(self.str_uncert+'hist_WZ_2L2Q','WZ_2L2Q'                        , 624225.0,   self.Xsection['WZ_2L2Q']        ,    ROOT.kMagenta)
        self.files['WZ_3LNu']            =file_object(self.str_uncert+'hist_WZ_3LNu','WZ_3LNu'                        , 19993200.0, self.Xsection['WZ_3LNu']        ,    ROOT.kMagenta)
        self.files['ZZ_2L2Nu']           =file_object(self.str_uncert+'hist_ZZ_2L2Nu','ZZ_2L2Nu'                      , 8912125.0,  self.Xsection['ZZ_2L2Nu']       ,    ROOT.kMagenta)
        self.files['ZZ_2L2Q']            =file_object(self.str_uncert+'hist_ZZ_2L2Q' ,'ZZ_2L2Q'                       , 496436.0,   self.Xsection['ZZ_2L2Q']        ,    ROOT.kMagenta)
        self.files['ZZ_4L']              =file_object(self.str_uncert+'hist_ZZ_4L'   ,'ZZ_4L'                         , 6669988.0,  self.Xsection['ZZ_4L']          ,    ROOT.kMagenta)
        ...
        if self.use_fewz_correct == False:
            self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_1F','Z#rightarrowee'          , 2998400.0,  self.Xsection['ZToEE_50_120']    ,     ROOT.kGreen)
            self.files_1F['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_1F','ZToEE_120_200'          , 100000.0,   self.Xsection['ZToEE_120_200']   ,     ROOT.kGreen)
            ...
            self.files_1F['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_1F','ZToEE_400_800'          , 100000.0,   self.Xsection['ZToEE_400_800']   ,     ROOT.kGreen)
            ...
            self.files_1F['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_1F','ZToEE_2300_3500'      , 100000.0,   self.Xsection['ZToEE_2300_3500'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_1F','ZToEE_3500_4500'      , 100000.0,   self.Xsection['ZToEE_3500_4500'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_1F','ZToEE_4500_6000'      , 99000.0,    self.Xsection['ZToEE_4500_6000'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_1F' ,'ZToEE_6000_Inf'       , 99800.0,    self.Xsection['ZToEE_6000_Inf']  ,     ROOT.kGreen)
        else:                                                                                                                                              
            self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz_1F','Z#rightarrowee'     , 2998400.0,  self.Xsection['ZToEE_50_120']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_fewz_1F','ZToEE_120_200'     , 100000.0,   self.Xsection['ZToEE_120_200']  ,     ROOT.kGreen)
            ...
            self.files_1F['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_fewz_1F','ZToEE_400_800'     , 100000.0,   self.Xsection['ZToEE_400_800']  ,     ROOT.kGreen)
            ...
            self.files_1F['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_fewz_1F','ZToEE_2300_3500' , 100000.0,   self.Xsection['ZToEE_2300_3500'],     ROOT.kGreen)
            self.files_1F['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_fewz_1F','ZToEE_3500_4500' , 100000.0,   self.Xsection['ZToEE_3500_4500'],     ROOT.kGreen)
            self.files_1F['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_fewz_1F','ZToEE_4500_6000' , 99000.0,    self.Xsection['ZToEE_4500_6000'],     ROOT.kGreen)
            self.files_1F['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_fewz_1F','ZToEE_6000_Inf'   , 99800.0,    self.Xsection['ZToEE_6000_Inf'] ,     ROOT.kGreen)
        self.files_1F['ZToTT_amc']          =file_object(self.str_uncert+'hist_ZToTT_1F','Z#rightarrow#tau#tau'             , 29137162.0, self.Xsection['ZToTT_amc']      ,     ROOT.kCyan)
        if self.use_TTbar_MLL == False:                                                                                                                           
            self.files_1F['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_all_1F','TTbar'                      , 79140880.0, self.Xsection['TTbar']          ,     ROOT.kYellow)
        else:                                                                                                                                               
            self.files_1F['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_500_1F','TTbar'                      , 79140880,   self.Xsection['TTbar']          ,     ROOT.kYellow)
            self.files_1F['TTbar_500_800']  =file_object(self.str_uncert+'hist_TTbar2L_500_800_1F','TTbar_500_800'          , 200000,     self.Xsection['TTbar_500_800']  ,     ROOT.kYellow)
            self.files_1F['TTbar_800_1200'] =file_object(self.str_uncert+'hist_TTbar2L_800_1200_1F','TTbar_800_1200'        , 199800,     self.Xsection['TTbar_800_1200'] ,     ROOT.kYellow)
            self.files_1F['TTbar_1200_1800']=file_object(self.str_uncert+'hist_TTbar2L_1200_1800_1F','TTbar_1200_1800'      , 200000,     self.Xsection['TTbar_1200_1800'],     ROOT.kYellow)
            self.files_1F['TTbar_1800_Inf'] =file_object(self.str_uncert+'hist_TTbar2L_1800_Inf_1F','TTbar_1800_Inf'        , 40829 ,     self.Xsection['TTbar_1800_Inf'] ,     ROOT.kYellow)
        self.files_1F['ST']                 =file_object(self.str_uncert+'hist_ST_1F','Single Top'                          , 8681495.0,  self.Xsection['ST']             ,     ROOT.kRed)
        self.files_1F['ST_anti']            =file_object(self.str_uncert+'hist_ST_anti_1F','ST_anti'                        , 8681541.0,  self.Xsection['ST_anti']        ,     ROOT.kRed)
        if self.use_WW_MLL == False:                                                                                                                          
            self.files_1F['WW']                 =file_object(self.str_uncert+'hist_WW_1F','Di-Boson'                        , 1999000.0,  self.Xsection['WW_inc']         ,     ROOT.kOrange)
        else:                                                                                                                             
            self.files_1F['WW']                 =file_object(self.str_uncert+'hist_WW2L_200_1F','Di-Boson'                  , 1999000.0,  self.Xsection['WW']             ,     ROOT.kOrange+2)
            self.files_1F['WW_200_600']         =file_object(self.str_uncert+'hist_WW2L_200_600_1F','WW2L_200_600'          , 200000.0,   self.Xsection['WW_200_600']     ,     ROOT.kOrange+2)
            self.files_1F['WW_600_1200']        =file_object(self.str_uncert+'hist_WW2L_600_1200_1F','WW2L_600_1200'        , 200000.0,   self.Xsection['WW_600_1200']    ,     ROOT.kOrange+2)
            self.files_1F['WW_1200_2500']       =file_object(self.str_uncert+'hist_WW2L_1200_2500_1F','WW2L_1200_2500'      , 200000.0,   self.Xsection['WW_1200_2500']   ,     ROOT.kOrange+2)
            self.files_1F['WW_2500_Inf']        =file_object(self.str_uncert+'hist_WW2L_2500_Inf_1F','WW2L_2500_Inf'        , 38969.0,    self.Xsection['WW_2500_Inf']    ,     ROOT.kOrange+2)
        self.files_1F['WZ_2L2Q']            =file_object(self.str_uncert+'hist_WZ_2L2Q_1F','WZ_2L2Q'                        , 624225.0,   self.Xsection['WZ_2L2Q']        ,     ROOT.kMagenta)
        self.files_1F['WZ_3LNu']            =file_object(self.str_uncert+'hist_WZ_3LNu_1F','WZ_3LNu'                        , 19993200.0, self.Xsection['WZ_3LNu']        ,     ROOT.kMagenta)
        self.files_1F['ZZ_2L2Nu']           =file_object(self.str_uncert+'hist_ZZ_2L2Nu_1F','ZZ_2L2Nu'                      , 8912125.0,  self.Xsection['ZZ_2L2Nu']       ,     ROOT.kMagenta)
        self.files_1F['ZZ_2L2Q']            =file_object(self.str_uncert+'hist_ZZ_2L2Q_1F' ,'ZZ_2L2Q'                       , 496436.0,   self.Xsection['ZZ_2L2Q']        ,     ROOT.kMagenta)
        self.files_1F['ZZ_4L']              =file_object(self.str_uncert+'hist_ZZ_4L_1F'   ,'ZZ_4L'                         , 6669988.0,  self.Xsection['ZZ_4L']          ,     ROOT.kMagenta)
    ...
    def get_lumi_normalized(self):
        ...
        for hname in self.normalize_hist_name:
            ...
            if True and ("normalization" not in self.sys_uncert and "lumi" not in self.sys_uncert):
                ...
                RunAll_scale   =0.945269
                RunAll_BB_scale=0.947922
                RunAll_BE_scale=0.937789
                RunAll_EE_scale=0.936958

                ###############  2016 result, prefiring ################
                RunAll_scale   =0.949993
                RunAll_BB_scale=0.948860
                RunAll_BE_scale=0.953177
                RunAll_EE_scale=1.001247

                ###############  2016 result, prefiring, updated trigger turn on ################
                RunAll_scale   =0.951640
                RunAll_BB_scale=0.950843
                RunAll_BE_scale=0.953862
                RunAll_EE_scale=1.001082

                ###############  2016 result, prefiring, updated trigger turn on, Gen_M for fewz ################
                RunAll_scale   =0.951472
                RunAll_BB_scale=0.950691
                RunAll_BE_scale=0.953648
                RunAll_EE_scale=1.000935



                ###############  2016 result, prefiring, No PUW ################
                #RunAll_scale   =0.961348
                #RunAll_BB_scale=0.959949
                #RunAll_BE_scale=0.965292
                #RunAll_EE_scale=1.015318


                ################  2016 result, prefiring up ################
                #RunAll_scale   =0.951268
                #RunAll_BB_scale=0.949129
                #RunAll_BE_scale=0.957341
                #RunAll_EE_scale=1.018158

                ################  2016 result, prefiring down ################
                #RunAll_scale   =0.948726
                #RunAll_BB_scale=0.948595
                #RunAll_BE_scale=0.949057
                #RunAll_EE_scale=0.984751
    ...
    def get_jets_hist(self):
        ...
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2016/20190621_GenM/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2016/20190703_fr_MasScale/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        f_jets=ROOT.TFile("ntuples/sys_saved_hist/2016/20190704_newBin/all/"+self.str_uncert+"hist_jets.root","RECREATE")
