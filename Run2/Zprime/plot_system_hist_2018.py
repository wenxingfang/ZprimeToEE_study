...
def draw_plots(date, out_dir, h_stack,h_mc,g_mc,h_data,out_name, blind):
    ...
    pad1.SetLogy()
    final_other_hist_title={'h_pv_n':'Nvtx','h_Ptll':'P_{T}(ee) [GeV]','h_Etall':'#eta(ee)','h_Phill':'#phi(ee)','h_led_Et':'E_{T}^{Leading} [GeV]','h_led_eta':'#eta^{Leading}','h_led_phi':'#phi^{Leading}',"h_led_Et_AM":'E_{T}^{Leading} [GeV]',"h_led_eta_AM":'#eta^{Leading}',"h_led_phi_AM":'#phi^{Leading}',"h_sub_Et_AM":'E_{T}^{Sub-leading} [GeV]',"h_sub_eta_AM":'#eta^{Sub-leading}',"h_sub_phi_AM":'#phi^{Sub-leading}','h_sub_Et':'E_{T}^{Sub-leading} [GeV]','h_sub_eta':'#eta^{Sub-leading}','h_sub_phi':'#phi^{Sub-leading}',"h_led_Et_v1":'E_{T}^{Leading} [GeV]',"h_led_eta_v1":'#eta^{Leading}',"h_led_phi_v1":'#phi^{Leading}',"h_sub_Et_v1":'E_{T}^{Sub-leading} [GeV]',"h_sub_eta_v1":'#eta^{Sub-leading}',"h_sub_phi_v1":'#phi^{Sub-leading}','h_MET':'MET [GeV]','h_MET_phi':'#phi^{MET}','h_MET_T1Txy':'MET(T1Txy) [GeV]','h_MET_phi_T1Txy':'#phi^{MET(T1Txy)}','h_MET_SF_T1Txy':'MET Significance','h_MET_Filter':'MET Filter','h_Dphi_ll':'#Delta#phi(e,e)','h_Dphi_MET_Z':'#Delta#phi(MET,ee)','h_DR_ll':'#DeltaR(e,e)','h_N_jet':'Number of jets','h_N_bjet':'Number of b jets','h_HT_sys':'HT^{system} [GeV]','h_Pt_sys':'P_{T}^{system} [GeV]','h_mee_Zpeak':'m(ee) [GeV]','h_mee_Zpeak_BB':'m(ee) [GeV]','h_mee_Zpeak_BE':'m(ee) [GeV]','h_mee_Zpeak_EE':'m(ee) [GeV]','h_mee_cosp':'m(ee) [GeV]','h_mee_cosp_BB':'m(ee) [GeV]','h_mee_cosp_BE':'m(ee) [GeV]','h_mee_cosp_EE':'m(ee) [GeV]','h_mee_cosm':'m(ee) [GeV]','h_mee_cosm_BB':'m(ee) [GeV]','h_mee_cosm_BE':'m(ee) [GeV]','h_mee_cosm_EE':'m(ee) [GeV]','h_cos':'cos#theta*','h_cos_BB':'cos#theta*','h_cos_BE':'cos#theta*','h_cos_EE':'cos#theta*','h_cos_all_region':'cos#theta*',"h_mee_Zpeak_EE_pp":'m(ee) [GeV]',"h_mee_Zpeak_EE_pm":'m(ee) [GeV]',"h_mee_Zpeak_EE_mm":'m(ee) [GeV]',"h_mee_Zpeak_EE_Heta":'m(ee) [GeV]',"h_mee_Zpeak_EE_Leta":'m(ee) [GeV]',"h_mee_Zpeak_EE_HLeta":'m(ee) [GeV]'}
...
#    canvas.SaveAs('%s/%s/%s.root'%(out_dir,date,out_name))    
    ...
    if out_name in ["h_mee_all",'h_mee_all_BB','h_mee_all_BE','h_mee_all_EE','h_mee_all_cumlative_v1','h_mee_all_cumlative_BE_v1','h_mee_all_cumlative_BB_v1','h_mee_all_cumlative_EE_v1'] and True:
        ...
        print h_jets_mee
        ####### for combine result ###################
        f_comb= ROOT.TFile("Result_2018.root","update")
        f_comb.cd()
        ...
        #############################################
        f_HEPData= ROOT.TFile("HEPData_2018.root","update")
        f_HEPData.cd()
...
#    ################ Fit background ####################
    ...
    if out_name in ["h_mee_usual","h_mee_BB_usual","h_mee_BE_usual"] and True:
        f_bgk_out= ROOT.TFile("bgk_2018.root","UPDATE");
        f_bgk_out.cd()
...
class file_object:
    def __init__(self, file_name, name, event, crosssection, color):
        ...
        self.color = color
        #self.tfilename = 'ntuples/sys_saved_hist/20180226_sys/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180301_different_run/runB/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180302_newTurnOn/all/%s.root'%(self.file_name)#final
        #self.tfilename = 'ntuples/sys_saved_hist/20180302_newTurnOn/runF/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180304_TT_WW_massbin_Check/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180306_TT_WW_massbin_Check/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180307_2017__TT_WW_check_sys/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180523_2017__TT_WW_check_sys/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180528/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180529_HEEPvar/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180616/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180629_matchHLTSeedLeg/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180629_matchHLTseedlegscaled/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180701_matchHLTseedleg_5050/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180701_matchHLTseedleg_4040/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180701_matchHLTseedleg_4545/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180702_matchHLTseedleg_4040_scale_smear/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180704_matchHLTseedleg_4545_scale_smear/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180710/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180713_ZToEE_120_100X_v1/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180713_ZToEE_100X_NOPUW/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180713_ZToEE_120_100X_NOPUW/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180713_DYToEE_pow_ZToEE_120_100X_NOPUW/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180714_ZToEE_100X_noPUW_scale_smear_v/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180714_DYToEE_120_ZToEE_100X_noPUW_scale_smear_v/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20180810_DY100X/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181124_MC_Aut18/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181124_MC_Aut18_DYToEEFor50_120/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181125_MC_Aut18_DYToEEFor50_120_smear2017/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181125_MC_Aut18_smear2017/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181127_MC_Aut18_DYToEEFor50_120_smear2017_scaled/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181205_Aut18ZToEE/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181205_Aut18DYToEE_50_120/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20181205_Aut18ZToEE_noPUW/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190128_Ele25_rereco_Aut18/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190128_Ele25_rereco_Aut18_DYToEE/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190216_Ele25_rereco_Aut18_DYToEE_rho/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190223_Ele25_rereco_Aut18_DYToEE_BEplus/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190223_Ele25_rereco_Aut18_DYToEE_BEminus/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190223_Ele25_rereco_Aut18_DYToEE_Runs/Run_A/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190223_Ele25_rereco_Aut18_DYToEE_Runs/Run_B/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190223_Ele25_rereco_Aut18_DYToEE_Runs/Run_C/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190223_Ele25_rereco_Aut18_DYToEE_Runs/Run_D/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190224_Ele25_rereco_Aut18_DYToEE_Eminus/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190224_Ele25_rereco_Aut18_DYToEE_Eplus/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190418_EGamma_scaled_smear/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190424_No_EGamma_scaled_smear/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190425_EGamma_scaled_smear/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190427_trkiso/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/20190505_triggerTurnOn/all/%s.root'%(self.file_name)
        ...
        #self.tfilename = 'ntuples/sys_saved_hist/20190610_EBminus/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190611/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190616/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190616_NoPUW/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190623_GenM/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190627_1TeV/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190628_1TeV/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190628_EENoTTW/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190703_fr_MasScale/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190703_5pBEscale/all/%s.root'%(self.file_name)
        #self.tfilename = 'ntuples/sys_saved_hist/2018/20190704_newBin/all/%s.root'%(self.file_name)
        self.tfilename = 'ntuples/sys_saved_hist/2018/20190809_UpdateRunD/all/%s.root'%(self.file_name)
...
#        self.DY_pdf_6000_Inf =DY_pdf_new(6000,7500)
    ...
    def get_input_file(self):
        ...
        if self.use_fewz_correct==False:
            #self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120','Z#rightarrowee'          , 8073000.0,  1921.8                           ,    ROOT.kGreen)##100X DYToEE_pow, NNPDF3.1
            self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120','Z#rightarrowee'          , 2780072.0,  self.Xsection['NNPDF31_ZToEE_50_120']    ,    ROOT.kGreen)
            self.files['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200','ZToEE_120_200'          , 99004.0,    self.Xsection['NNPDF31_ZToEE_120_200']   ,    ROOT.kGreen)
            self.files['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400','ZToEE_200_400'          , 99546.0,    self.Xsection['NNPDF31_ZToEE_200_400']   ,    ROOT.kGreen)
            self.files['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800','ZToEE_400_800'          , 99898.0,    self.Xsection['NNPDF31_ZToEE_400_800']   ,    ROOT.kGreen)
            self.files['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400','ZToEE_800_1400'        , 99972.0,    self.Xsection['NNPDF31_ZToEE_800_1400']  ,    ROOT.kGreen)
            self.files['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300','ZToEE_1400_2300'      , 99988.0,    self.Xsection['NNPDF31_ZToEE_1400_2300'] ,    ROOT.kGreen)
            self.files['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500','ZToEE_2300_3500'      , 97958.0,    self.Xsection['NNPDF31_ZToEE_2300_3500'] ,    ROOT.kGreen)
            self.files['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500','ZToEE_3500_4500'      , 99830.0,    self.Xsection['NNPDF31_ZToEE_3500_4500'] ,    ROOT.kGreen)
            self.files['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000','ZToEE_4500_6000'      , 99368.0,    self.Xsection['NNPDF31_ZToEE_4500_6000'] ,    ROOT.kGreen)
            self.files['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf','ZToEE_6000_Inf'        , 98162.0,    self.Xsection['NNPDF31_ZToEE_6000_Inf']  ,    ROOT.kGreen)
        else:
            #self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz','Z#rightarrowee'     , 8073000.0,  1921.8                        ,    ROOT.kGreen)##100X DYToEE_pow, NNPDF3.1
            self.files['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz','Z#rightarrowee'     , 2780072.0,  self.Xsection['NNPDF31_ZToEE_50_120']   ,    ROOT.kGreen)
            self.files['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_fewz','ZToEE_120_200'     , 99004.0,    self.Xsection['NNPDF31_ZToEE_120_200']  ,    ROOT.kGreen)
            self.files['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400_fewz','ZToEE_200_400'     , 99546.0,    self.Xsection['NNPDF31_ZToEE_200_400']  ,    ROOT.kGreen)
            self.files['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_fewz','ZToEE_400_800'     , 99898.0,    self.Xsection['NNPDF31_ZToEE_400_800']  ,    ROOT.kGreen)
            self.files['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400_fewz','ZToEE_800_1400'   , 99972.0,    self.Xsection['NNPDF31_ZToEE_800_1400'] ,    ROOT.kGreen)
            self.files['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300_fewz','ZToEE_1400_2300' , 99988.0,    self.Xsection['NNPDF31_ZToEE_1400_2300'],    ROOT.kGreen)
            self.files['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_fewz','ZToEE_2300_3500' , 97958.0,    self.Xsection['NNPDF31_ZToEE_2300_3500'],    ROOT.kGreen)
            self.files['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_fewz','ZToEE_3500_4500' , 99830.0,    self.Xsection['NNPDF31_ZToEE_3500_4500'],    ROOT.kGreen)
            self.files['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_fewz','ZToEE_4500_6000' , 99368.0,    self.Xsection['NNPDF31_ZToEE_4500_6000'],    ROOT.kGreen)
            self.files['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_fewz','ZToEE_6000_Inf'   , 98162.0,    self.Xsection['NNPDF31_ZToEE_6000_Inf'] ,    ROOT.kGreen)
        self.files['ZToTT_amc']          =file_object(self.str_uncert+'hist_ZToTT_amc','Z#rightarrow#tau#tau'         , 120782699.0,self.Xsection['ZToTT_amc']      ,    ROOT.kCyan)
        if self.use_TTbar_MLL == False: 
            self.files['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_all','TTbar'                      , 60458546.0, self.Xsection['TTbar']          ,    ROOT.kYellow)
        else:
            self.files['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_500','TTbar'                      , 60458546.0, self.Xsection['TTbar']          ,    ROOT.kYellow)
        ...
        if self.use_WW_MLL == False: 
            self.files['WW']                 =file_object(self.str_uncert+'hist_WW','Di-Boson'                        , 7850000.0,  self.Xsection['WW_inc']         ,    ROOT.kMagenta)
        else:
            self.files['WW']                 =file_object(self.str_uncert+'hist_WW2L_200','Di-Boson'                  , 7450398.0,  self.Xsection['WW']             ,    ROOT.kMagenta)
        ...
        self.files['ST']                 =file_object(self.str_uncert+'hist_ST','Single Top'                          , 8604210.0,  self.Xsection['ST']             ,    ROOT.kRed)
        self.files['ST_anti']            =file_object(self.str_uncert+'hist_ST_anti','ST_anti'                        , 6878049.0,  self.Xsection['ST_anti']        ,    ROOT.kRed)
        self.files['WZ_2L2Q']            =file_object(self.str_uncert+'hist_WZ_2L2Q','WZ_2L2Q'                        , 23719470.0, self.Xsection['WZ_2L2Q']        ,    ROOT.kMagenta)
        self.files['WZ_3LNu']            =file_object(self.str_uncert+'hist_WZ_3LNu','WZ_3LNu'                        , 1955248.0,  self.Xsection['WZ_3LNu']        ,    ROOT.kMagenta)
        self.files['ZZ_2L2Nu']           =file_object(self.str_uncert+'hist_ZZ_2L2Nu','ZZ_2L2Nu'                      , 54199652.0, self.Xsection['ZZ_2L2Nu']       ,    ROOT.kMagenta)
        self.files['ZZ_2L2Q']            =file_object(self.str_uncert+'hist_ZZ_2L2Q' ,'ZZ_2L2Q'                       , 17405267.0, self.Xsection['ZZ_2L2Q']        ,    ROOT.kMagenta)
        self.files['ZZ_4L']              =file_object(self.str_uncert+'hist_ZZ_4L'   ,'ZZ_4L'                         , 98495102.0, self.Xsection['ZZ_4L']          ,    ROOT.kMagenta)
        ...
        if self.use_fewz_correct == False:
            #self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_1F','Z#rightarrowee'          , 8073000.0,  1921.8      ,    ROOT.kGreen)##100X DYToEE_pow, NNPDF3.1
            self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_1F','Z#rightarrowee'          , 2780072.0,  self.Xsection['NNPDF31_ZToEE_50_120']    ,     ROOT.kGreen)
            self.files_1F['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_1F','ZToEE_120_200'          , 99004.0,    self.Xsection['NNPDF31_ZToEE_120_200']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400_1F','ZToEE_200_400'          , 99546.0,    self.Xsection['NNPDF31_ZToEE_200_400']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_1F','ZToEE_400_800'          , 99898.0,    self.Xsection['NNPDF31_ZToEE_400_800']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400_1F','ZToEE_800_1400'        , 99972.0,    self.Xsection['NNPDF31_ZToEE_800_1400']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300_1F','ZToEE_1400_2300'      , 99988.0,    self.Xsection['NNPDF31_ZToEE_1400_2300'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_1F','ZToEE_2300_3500'      , 97958.0,    self.Xsection['NNPDF31_ZToEE_2300_3500'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_1F','ZToEE_3500_4500'      , 99830.0,    self.Xsection['NNPDF31_ZToEE_3500_4500'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_1F','ZToEE_4500_6000'      , 99368.0,    self.Xsection['NNPDF31_ZToEE_4500_6000'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_1F' ,'ZToEE_6000_Inf'       , 98162.0,    self.Xsection['NNPDF31_ZToEE_6000_Inf']  ,     ROOT.kGreen)
        else:                                                                                                                                              
            #self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz_1F','Z#rightarrowee'     , 8073000.0,  1921.8      ,    ROOT.kGreen)##100X DYToEE_pow, NNPDF3.1
            self.files_1F['ZToEE_50_120']   =file_object(self.str_uncert_Z+'hist_ZToEE_50_120_fewz_1F','Z#rightarrowee'     , 2780072.0,  self.Xsection['NNPDF31_ZToEE_50_120']   ,     ROOT.kGreen)
            self.files_1F['ZToEE_120_200']  =file_object(self.str_uncert_Z+'hist_ZToEE_120_200_fewz_1F','ZToEE_120_200'     , 99004.0,    self.Xsection['NNPDF31_ZToEE_120_200']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_200_400']  =file_object(self.str_uncert_Z+'hist_ZToEE_200_400_fewz_1F','ZToEE_200_400'     , 99546.0,    self.Xsection['NNPDF31_ZToEE_200_400']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_400_800']  =file_object(self.str_uncert_Z+'hist_ZToEE_400_800_fewz_1F','ZToEE_400_800'     , 99898.0,    self.Xsection['NNPDF31_ZToEE_400_800']  ,     ROOT.kGreen)
            self.files_1F['ZToEE_800_1400'] =file_object(self.str_uncert_Z+'hist_ZToEE_800_1400_fewz_1F','ZToEE_800_1400'   , 99972.0,    self.Xsection['NNPDF31_ZToEE_800_1400'] ,     ROOT.kGreen)
            self.files_1F['ZToEE_1400_2300']=file_object(self.str_uncert_Z+'hist_ZToEE_1400_2300_fewz_1F','ZToEE_1400_2300' , 99988.0,    self.Xsection['NNPDF31_ZToEE_1400_2300'],     ROOT.kGreen)
            self.files_1F['ZToEE_2300_3500']=file_object(self.str_uncert_Z+'hist_ZToEE_2300_3500_fewz_1F','ZToEE_2300_3500' , 97958.0,    self.Xsection['NNPDF31_ZToEE_2300_3500'],     ROOT.kGreen)
            self.files_1F['ZToEE_3500_4500']=file_object(self.str_uncert_Z+'hist_ZToEE_3500_4500_fewz_1F','ZToEE_3500_4500' , 99830.0,    self.Xsection['NNPDF31_ZToEE_3500_4500'],     ROOT.kGreen)
            self.files_1F['ZToEE_4500_6000']=file_object(self.str_uncert_Z+'hist_ZToEE_4500_6000_fewz_1F','ZToEE_4500_6000' , 99368.0,    self.Xsection['NNPDF31_ZToEE_4500_6000'],     ROOT.kGreen)
            self.files_1F['ZToEE_6000_Inf'] =file_object(self.str_uncert_Z+'hist_ZToEE_6000_Inf_fewz_1F','ZToEE_6000_Inf'   , 98162.0,    self.Xsection['NNPDF31_ZToEE_6000_Inf'] ,     ROOT.kGreen)
        self.files_1F['ZToTT_amc']          =file_object(self.str_uncert+'hist_ZToTT_amc_1F','Z#rightarrow#tau#tau'         , 120782699.0,self.Xsection['ZToTT_amc']      ,     ROOT.kCyan)
        if self.use_TTbar_MLL == False:                                                                                                                           
            self.files_1F['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_all_1F','TTbar'                      , 60458546.0, self.Xsection['TTbar']          ,     ROOT.kYellow)
        else:                                                                                                                                               
            self.files_1F['TTbar']          =file_object(self.str_uncert+'hist_TTbar2L_500_1F','TTbar'                      , 60458546.0, self.Xsection['TTbar']          ,     ROOT.kYellow)
        ...
        if self.use_WW_MLL == False:                                                                                                                          
            self.files_1F['WW']                 =file_object(self.str_uncert+'hist_WW_1F','Di-Boson'                        , 7850000.0,  self.Xsection['WW_inc']         ,     ROOT.kOrange)
        else:                                                                                                                             
            self.files_1F['WW']                 =file_object(self.str_uncert+'hist_WW2L_200_1F','Di-Boson'                  , 7450398.0,  self.Xsection['WW']             ,     ROOT.kOrange+2)
        ...
        self.files_1F['ST']                 =file_object(self.str_uncert+'hist_ST_1F','Single Top'                          , 8604210.0,  self.Xsection['ST']             ,     ROOT.kRed)
        self.files_1F['ST_anti']            =file_object(self.str_uncert+'hist_ST_anti_1F','ST_anti'                        , 6878049.0,  self.Xsection['ST_anti']        ,     ROOT.kRed)
        self.files_1F['WZ_2L2Q']            =file_object(self.str_uncert+'hist_WZ_2L2Q_1F','WZ_2L2Q'                        , 23719470.0, self.Xsection['WZ_2L2Q']        ,     ROOT.kMagenta)
        self.files_1F['WZ_3LNu']            =file_object(self.str_uncert+'hist_WZ_3LNu_1F','WZ_3LNu'                        , 1955248.0,  self.Xsection['WZ_3LNu']        ,     ROOT.kMagenta)
        self.files_1F['ZZ_2L2Nu']           =file_object(self.str_uncert+'hist_ZZ_2L2Nu_1F','ZZ_2L2Nu'                      , 54199652.0, self.Xsection['ZZ_2L2Nu']       ,     ROOT.kMagenta)
        self.files_1F['ZZ_2L2Q']            =file_object(self.str_uncert+'hist_ZZ_2L2Q_1F' ,'ZZ_2L2Q'                       , 17405267.0, self.Xsection['ZZ_2L2Q']        ,     ROOT.kMagenta)
        self.files_1F['ZZ_4L']              =file_object(self.str_uncert+'hist_ZZ_4L_1F'   ,'ZZ_4L'                         , 98495102.0, self.Xsection['ZZ_4L']          ,     ROOT.kMagenta)
    ...
    def get_lumi_normalized(self):
        ...
        #other_hist=["h_pv_n","h_Ptll","h_Etall","h_Phill","h_led_Et","h_led_eta","h_led_phi","h_sub_Et","h_sub_eta","h_sub_phi","h_led_Et_v1","h_led_eta_v1","h_led_phi_v1","h_sub_Et_v1","h_sub_eta_v1","h_sub_phi_v1","h_led_Et_AM","h_led_eta_AM","h_led_phi_AM","h_sub_Et_AM","h_sub_eta_AM","h_sub_phi_AM","h_MET","h_MET_phi","h_MET_T1Txy","h_MET_phi_T1Txy","h_MET_SF_T1Txy","h_MET_Filter","h_Dphi_ll","h_Dphi_MET_Z","h_DR_ll","h_N_jet","h_N_bjet","h_HT_sys","h_Pt_sys","h_mee_Zpeak","h_mee_Zpeak_BB","h_mee_Zpeak_BE","h_mee_Zpeak_EE","h_mee_Zpeak_EE_pp","h_mee_Zpeak_EE_pm","h_mee_Zpeak_EE_mm","h_mee_Zpeak_EE_Heta","h_mee_Zpeak_EE_Leta","h_mee_Zpeak_EE_HLeta"]
        ...
        for hname in self.normalize_hist_name:
            ...
            if True and ("normalization" not in self.sys_uncert and "lumi" not in self.sys_uncert):
                ...
                ###############  Aut18 MC, DYToEE for Zpeak , Apply 2018 scale and smearing ################



                RunAll_scale   =0.931387
                RunAll_BB_scale=0.929002
                RunAll_BE_scale=0.937492
                RunAll_EE_scale=1.019416


                RunAll_scale   =0.931319
                RunAll_BB_scale=0.928995
                RunAll_BE_scale=0.937264
                RunAll_EE_scale=1.019389

                ###############  Aut18 MC, DYToEE for Zpeak , Apply 2018 scale and smearing, new HEEP ID ################
                RunAll_scale   =0.929628
                RunAll_BB_scale=0.929125
                RunAll_BE_scale=0.930901
                RunAll_EE_scale=0.998057


                ###############  Aut18 MC, DYToEE for Zpeak , Apply 2018 scale and smearing, new HEEP ID, don't use Endcap+ ################
                RunAll_scale   =0.929885
                RunAll_BB_scale=0.929125
                RunAll_BE_scale=0.933713
                RunAll_EE_scale=1.000080

                ## new select code
                RunAll_scale   =0.929635
                RunAll_BB_scale=0.929129
                RunAll_BE_scale=0.930915
                RunAll_EE_scale=0.998061


                ###############  DYToEE for Zpeak , NNPDF weight ################

                RunAll_scale   =0.976167
                RunAll_BB_scale=0.972706
                RunAll_BE_scale=0.985021
                RunAll_EE_scale=1.032847


                ###############  DYToEE for Zpeak , NNPDF weight, No PUW ################
                RunAll_scale   =0.988892
                RunAll_BB_scale=0.985143
                RunAll_BE_scale=0.998486
                RunAll_EE_scale=1.049666

                ############### Final NNPDF weight################

                RunAll_scale   =0.946177
                RunAll_BB_scale=0.949421
                RunAll_BE_scale=0.938068
                RunAll_EE_scale=0.980317


                ############### update runD ################
                RunAll_scale   =0.946127
                RunAll_BB_scale=0.949371
                RunAll_BE_scale=0.938017
                RunAll_EE_scale=0.980259
    ...
    def get_jets_hist(self):
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/20190418_EGamma_scaled_smear/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/20190424_No_EGamma_scaled_smear/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/20190425_EGamma_scaled_smear/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/20190427_trkiso/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/20190505_triggerTurnOn/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        ...
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/20190610_EBminus/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190611/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190616/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190616_NoPUW/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190623_GenM/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190627_1TeV/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190628_1TeV/all/"+self.str_uncert+"hist_jets.root","RECREATE")
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190628_EENoTTW/all/"+self.str_uncert+"hist_jets.root","RECREATE") 
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190703_fr_MasScale/all/"+self.str_uncert+"hist_jets.root","RECREATE") # for final
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190703_5pBEscale/all/"+self.str_uncert+"hist_jets.root","RECREATE") # for check
        #f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190704_newBin/all/"+self.str_uncert+"hist_jets.root","RECREATE") # for check
        f_jets=ROOT.TFile("ntuples/sys_saved_hist/2018/20190809_UpdateRunD/all/"+self.str_uncert+"hist_jets.root","RECREATE") # for check
...
#                    h_QCD.Sumw2()
                    ...
                    Scale = float(region_events/QCD_region_events) if QCD_region_events!=0 else 1
                    h_QCD.Scale(Scale)
                    for bin in range(1,h_jets.GetNbinsX()+1):
...
#final_other_hist=["h_pv_n","h_Ptll","h_Etall","h_Phill","h_led_Et","h_led_eta","h_led_phi","h_sub_Et","h_sub_eta","h_sub_phi","h_led_Et_v1","h_led_eta_v1","h_led_phi_v1","h_sub_Et_v1","h_sub_eta_v1","h_sub_phi_v1","h_led_Et_AM","h_led_eta_AM","h_led_phi_AM","h_sub_Et_AM","h_sub_eta_AM","h_sub_phi_AM","h_MET","h_MET_phi","h_MET_T1Txy","h_MET_phi_T1Txy","h_MET_SF_T1Txy","h_MET_Filter","h_Dphi_ll","h_Dphi_MET_Z","h_DR_ll","h_N_jet","h_N_bjet","h_HT_sys","h_Pt_sys","h_mee_Zpeak","h_mee_Zpeak_BB","h_mee_Zpeak_BE","h_mee_Zpeak_EE","h_mee_Zpeak_EE_pp","h_mee_Zpeak_EE_pm","h_mee_Zpeak_EE_mm","h_mee_Zpeak_EE_Heta","h_mee_Zpeak_EE_Leta","h_mee_Zpeak_EE_HLeta"]
...
####    #############    print table 
        ...
        #Mass_range_list=[[60,120],[120,400],[400,600],[600,900],[900,1500],[1500,6000]]
        #Mass_range_list=[[60,120],[140,4000]]
...
####    ### For combine some uncertainty###########
        combine_list=["normalization","lumi","pdf","mass","PU","bgk","SF","total"]
