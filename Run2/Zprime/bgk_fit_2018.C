...
TFile* f = new TFile("bgk_2018.root","READ");
...
//const float fit_low=1500;//150
//const float fit_up=4000;// orignal 4000
const float fit_up=5000;// orignal 4000
...
lumi_label.DrawLatex(0.68,label_y , "59.4 fb^{-1} (13 TeV)");
TLatex region_label ;
...
lumi_label.SetNDC(kTRUE);
lumi_label.DrawLatex(0.2,0.20 , "59.4 fb^{-1}, 13 TeV");
TLatex region_label ;
region_label.SetTextSize(0.04);
region_label.SetNDC(kTRUE);
TString mass_range = Form("(%.0f-%.0f GeV)",frame->GetXaxis()->GetXmin(),frame->GetXaxis()->GetXmax());
